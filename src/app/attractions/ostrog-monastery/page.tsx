        ...
        <div className="space-y-8">
          ...
          <Section title="3. 历史背景">
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p className="text-gray-700 leading-relaxed mb-4">{`故事要从十七世纪中叶讲起，那时黑山土地正深受奥斯曼帝国的侵扰与压迫。我们的主角，圣瓦西里·奥斯特罗什基，原本是波斯尼亚和黑塞哥维那地区一座修道院的主教。他并非王公贵族，却以深邃的智慧、治愈的能力和对人民的无限慈悲闻名。据说，为了寻找一个能远离战乱、潜心修行并能庇护信徒的安宁之所，他进行了漫长的跋涉。当他来到这座当时名为“奥斯特罗格”的荒芜山崖下时，一个神启般的景象出现了：一道光，精准地照射在半山腰一个巨大的天然岩缝上。对圣瓦西里而言，这不再是险峻的绝壁，而是一个天然的堡垒，一个离上帝更近的祭坛。于是，在1665年左右，近乎疯狂的工程开始了。没有现代机械，工匠和信徒们仅凭绳索、锤凿和无穷的信念，将木材与石料运上悬崖，巧妙地利用岩洞和缝隙，搭建起了最初的祈祷所和栖身之所。这不仅是建筑，更是一场集体性的苦修与奉献。`}</p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">{`今天的奥斯特罗格，管理者依然是虔诚的东正教修道士。他们过着简朴清修的生活，负责主持日常的祈祷仪式，照料烛火，并为络绎不绝的访客提供精神上的指引。你可能会看到他们穿着黑色长袍，静静地穿过人群，表情平和而专注。他们延续着圣瓦西里的传统，让这里不仅仅是一个旅游景点，更是一个活着的、呼吸的信仰中心。从塞尔维亚、波斯尼亚和黑塞哥维那、马其顿乃至更远地方而来的朝圣者，常常带着睡袋，在修道院下方的空地或指定区域过夜，只为参加清晨的第一场礼拜。这种延续了三百多年的传统，让奥斯特罗格的每一块石头、每一缕空气，都浸透了祷告的温度与时间的力量。`}</p>
            </div>
          </Section>
