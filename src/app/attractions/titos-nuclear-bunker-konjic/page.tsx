...
export const metadata: Metadata = {
  ...
  description: '探索波斯尼亚和黑塞哥维那科尼茨(Tito‘s Bunker, Konjic)震撼人心的冷战遗迹。这份深度游攻略带你走进铁托的秘密核掩体，揭秘一日游路线、门票交通与最真实的“时间胶囊”体验。',
}
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <Breadcrumb
          items={[
            ...
            { label: '科尼茨', href: '/destinations/bosnia-and-herzegovina' },
            { label: '科尼茨铁托核掩体', href: '/attractions/titos-nuclear-bunker-konjic' },
          ]}
        />

        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{`科尼茨铁托核掩体・Tito's Bunker (ARK D-0)・波斯尼亚和黑塞哥维那・科尼茨`}</h1>
          <p className="text-lg text-gray-600 mb-6">
            {`嘿，朋友，想象一下：在波斯尼亚和黑塞哥维那南部一个宁静得只听得见内雷特瓦河水声和鸟鸣的山间小镇，脚下深处却埋藏着南斯拉夫时期为世界大战准备的终极秘密。这不是电影场景，而是科尼茨带给你的真实震撼。今天这份科尼茨铁托地堡私藏旅游攻略，就带你躲开寻常的游客路线，钻进那座代号“D-0”、掏空整座山脉建造的超级核掩体。作为你的专属向导，这份自由行指南请收好——我们将一起揭开这处冷战时期“东方阵营”最庞大、最隐秘工程的面纱，感受那种深入骨髓的历史凉意与时空错位感。这绝对是你巴尔干之旅中，最颠覆想象的一站。`}
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <Section title="1. 景点介绍">
              <p className="text-gray-700 leading-relaxed mb-4">{`嘿，朋友，想象一下：在波斯尼亚和黑塞哥维那南部一个宁静得只听得见内雷特瓦河水声和鸟鸣的山间小镇，脚下深处却埋藏着南斯拉夫时期为世界大战准备的终极秘密。这不是电影场景，而是科尼茨带给你的真实震撼。今天这份科尼茨铁托地堡私藏旅游攻略，就带你躲开寻常的游客路线，钻进那座代号“D-0”、掏空整座山脉建造的超级核掩体。作为你的专属向导，这份自由行指南请收好——我们将一起揭开这处冷战时期“东方阵营”最庞大、最隐秘工程的面纱，感受那种深入骨髓的历史凉意与时空错位感。这绝对是你巴尔干之旅中，最颠覆想象的一站。`}</p>
          </Section>
          ...
          <Section title="2. 基本信息">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <InfoRow label="文化价值" value={`对于今天的波斯尼亚和黑塞哥维那人乃至所有来访者，科尼茨地堡早已超越了一个军事遗迹的意义。它是一本立体的历史教科书，直观地展示了那个分裂世界的恐惧如何转化为如此浩大而隐秘的工程。对当地社区而言，它从最高国家机密转变为重要的旅游资源和文化地标，为科尼茨这个宁静小镇带来了独特的关注度，也促使人们重新审视那段复杂的历史。更重要的是，它已成为一个强大的文化反思媒介。近年来，地堡的部分空间被用于举办名为“Bunker”的当代艺术展，来自世界各地的艺术家用装置、绘画、影像作品回应这个空间，探讨战争、和平、隐私、监控、生存等永恒主题。当先锋艺术与冰冷的军事遗迹碰撞，产生了奇妙的化学反应：历史不再是尘封的往事，而是与当下对话的活体。它提醒我们，意识形态的壁垒或许已改变形态，但人类对安全与生存的深层焦虑，以及权力运作的方式，依然值得持续审视。`} />
              </div>
            </div>
          ...
          <Section title={`6. 科尼茨周边住宿选择与地道美食攻略`}>
            <div className="space-y-6">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">{`餐饮方面，在科尼茨镇，一定要尝试河畔的 Restoran Konak 或 Kod Ane。除了必点的Ćevapi，别忘了尝尝 Trout（鳟鱼），内雷特瓦河的冷水鳟鱼鲜美无比，简单烤制就足够美味。配上一杯当地的白葡萄酒或波斯尼亚和黑塞哥维那咖啡，坐在河边的露台上，看着对岸的青山和偶尔掠过的皮划艇，你会由衷感慨：生活真美好——这种感受，在刚从地堡出来时，会尤其深刻和珍贵。`}</p>
              </div>
            </div>
          </Section>
          ...
          <Section title="7. 周边延伸探索">
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 text-gray-700 leading-relaxed">
              <p className="text-gray-700 leading-relaxed mb-4">{`强烈推荐你用散步的方式探索科尼茨古镇本身，它就是最值得的“周边”。走过古老的石桥（Stari most），它虽不如莫斯塔尔那座著名，但更显古朴宁静。桥下的内雷特瓦河是罕见的翡翠色，夏季常有当地人跳水游泳，充满生机。穿过桥，就是奥斯曼时期留下的老巴扎（Čaršija）区域，狭窄的石板路两旁是低矮的石头房子，手工艺品小店和咖啡馆散落其中，时间在这里慢了下来。另一个方向，可以徒步一段前往科尼茨要塞的遗迹，从那里可以俯瞰整个小镇和河谷，景色开阔，与地堡的封闭压抑形成完美的互补。这两个地方都不需要门票，却能给你最地道的波斯尼亚和黑塞哥维那小镇风光。`}</p>
            </div>
          </Section>
