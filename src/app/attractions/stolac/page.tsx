...
export const metadata: Metadata = {
  title: '波斯尼亚和黑塞哥维那斯托拉茨深度旅游攻略：探秘千年巨石墓碑与奥斯曼水车的老城时光',
  description: '探索波斯尼亚和黑塞哥维那斯托拉茨(Stolac)，揭秘欧洲最集中的斯特查克巨石墓碑群与奥斯曼水车。这份深度游攻略涵盖小众景点推荐、一日游路线及实用避坑指南。',
}
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <Breadcrumb
          items={[
            ...
            { label: '黑塞哥维那-内雷特瓦州', href: '/destinations/bosnia-and-herzegovina' },
            { label: '斯托拉茨', href: '/attractions/stolac' },
          ]}
        />

        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{`斯托拉茨・Stolac・波斯尼亚和黑塞哥维那・黑塞哥维那-内雷特瓦州`}</h1>
          <p className="text-lg text-gray-600 mb-6">
            {`嘿，朋友，如果告诉你，在波斯尼亚和黑塞哥维那南部藏着一座能同时与史前先民和奥斯曼帝国工匠对话的小城，你会心动吗？今天这份斯托拉茨私藏旅游攻略，就带你躲开常规巴尔干路线的人潮，潜入这座被布雷加瓦河温柔穿过的老城。这里被誉为“露天博物馆”，左手边是散落山野、刻满神秘符号的千年巨石墓碑（斯特查克），右手边是沿河排列、吱呀作响了数百年的奥斯曼木制水车。作为你的专属向导，这份斯托拉茨自由行指南请收好——它不只告诉你“看什么”，更会分享如何感受石头与水声中流淌的时间。准备好，我们要开始一场穿越万年的漫步了。`}
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <Section title="1. 景点介绍">
              <p className="text-gray-700 leading-relaxed mb-4">{`嘿，朋友，如果告诉你，在波斯尼亚和黑塞哥维那南部藏着一座能同时与史前先民和奥斯曼帝国工匠对话的小城，你会心动吗？今天这份斯托拉茨私藏旅游攻略，就带你躲开常规巴尔干路线的人潮，潜入这座被布雷加瓦河温柔穿过的老城。这里被誉为“露天博物馆”，左手边是散落山野、刻满神秘符号的千年巨石墓碑（斯特查克），右手边是沿河排列、吱呀作响了数百年的奥斯曼木制水车。作为你的专属向导，这份斯托拉茨自由行指南请收好——它不只告诉你“看什么”，更会分享如何感受石头与水声中流淌的时间。准备好，我们要开始一场穿越万年的漫步了。`}</p>
          </Section>
          ...
          <Section title="2. 基本信息">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <InfoRow label="文化价值" value={`对于当地人而言，斯托拉茨的巨石与水车不仅是景点，更是身份与日常的根基。斯特查克墓碑是家族历史与祖先记忆的地理坐标，许多本地人的根源感与之紧密相连。它们也是波斯尼亚和黑塞哥维那多元文化共存的古老象征，提醒着人们这片土地在宗教分歧之前的复杂与统一。而奥斯曼水车（当地称“水车谷”），则曾是这个社区的经济命脉，磨出的面粉滋养了一代代人。尽管许多已不再运转，但它们的声音和形象已刻入城市的文化基因，成为诗歌、绘画和民间传说的灵感源泉。在现代社会，斯托拉茨以其无可比拟的遗产组合，成为反思历史层叠性、人类与自然关系以及文化遗产保护的活教材。它低调地展示着：伟大的文化价值，不仅可以存在于大教堂和宫殿，也同样存在于山野间的石碑和河畔吱呀作响的水车里。`} />
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  {`咱们就花一天时间，悠闲地走完斯托拉茨的精华。上午（追寻石头的记忆）：建议9点左右抵达，先从城外的拉德米利亚山区域开始。这里的山坡上集中了大量斯特查克墓碑，清晨光线柔和，最适合拍照和静静观摩那些神秘雕刻。花一个半到两小时，在山野间漫步“寻宝”。中午（老城与午餐）：慢慢步行下山，进入斯托拉茨老城中心。在奥斯曼风格的老街（Čaršija）找一家家庭餐馆，尝尝用本地食材做的传统波斯尼亚和黑塞哥维那菜，比如“ćevapi”肉肠或炖菜。下午（水声与时光）：饭后散步至布雷加瓦河畔，沿着“水车谷”的步道行走。这里是下午游览的重点，听着水声，看着阳光下闪耀的水花，感受与上午完全不同的灵动气息。可以参观一两个修复后仍可演示的水车磨坊。傍晚（登高望远）：如果体力尚可，可以爬上老城旁的Vidoški堡垒遗址（需短途徒步），在山顶俯瞰整个斯托拉茨老城、河流和水车群的全景，在金色夕阳中结束完美的一天。`}
                </p>
