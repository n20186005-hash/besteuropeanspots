...
export const metadata: Metadata = {
  ...
  description: '你绝不会想到，在波黑这片以战争伤痕和古老石桥闻名的土地上，竟藏着这样一片奔腾的、翡翠般的仙境。车子在干燥的、布满碎石的山路上拐了最后一个弯，闷热的空气里忽然渗入一股沁凉的水汽，紧接着，那如同遥远雷鸣般的轰响便扑面而来。走下缓坡，绕过一片橡树林，眼前豁然开朗——那一刻的震撼，是任何照片都无法承载的。那...',
}
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{`克拉维察瀑布・Kravica Waterfall・波斯尼亚和黑塞哥维那（波黑）・柳布什基（根据常理推断，瀑布位于西黑塞哥维那州，柳布什基市为其主要交通枢纽）`}</h1>
          <p className="text-lg text-gray-600 mb-6">
            {`你绝不会想到，在波黑这片以战争伤痕和古老石桥闻名的土地上，竟藏着这样一片奔腾的、翡翠般的仙境。车子在干燥的、布满碎石的山路上拐了最后一个弯，闷热的空气里忽然渗入一股沁凉的水汽，紧接着，那如同遥远雷鸣般的轰响便扑面而来。走下缓坡，绕过一片橡树林，眼前豁然开朗——那一刻的震撼，是任何照片都无法承载的。那不是一个瀑布，而是一堵弧形的、宽达百余米的、活生生的绿墙。特雷比扎尼卡河的水流在这里被无数钙华阶地温柔地撕碎，化作千百条银白色的水练，从长满青苔和蕨类的墨绿色岩壁上奔腾跃下，坠入下方那一汪深不见底的、闪烁着魔幻祖母绿光泽的潭水中。
...
这里绝非一个仅供远观的景点。它是活的，是深深嵌入当地人生活肌理中的“后花园”。你会看到穿着泳衣的一家老小，在潭边铺开彩色的野餐垫，祖父母在树荫下喝着咖啡，父亲带着儿子从较低的岩石上练习跳水，而少年们则奋力游向瀑布最汹涌的下方，享受水流冲击背部的天然按摩。小贩在岸边支起简易的棚子，烤着滋滋作响的ćevapi（波黑肉卷），空气中飘散着烤肉和新鲜面包的香气。这不是一个被玻璃罩起来的自然保护区，而是一个充满烟火气的、人与自然共享的狂欢地。
它的核心魅力，就在于这种极致的反差与和谐的统一。一边是自然界经过千万年耐心沉淀、雕刻出的宏伟与静谧；另一边是人类最本真的嬉戏、欢笑与生活气息。它不像那些需要你屏息凝神、保持距离的圣地，而是张开怀抱，邀请你脱下鞋袜，跳进那翡翠般的潭水，成为这幅生机盎然画卷中的一部分。在这里，你感受到的不是历史的沉重，而是生命本身那种清凉、奔放、不受约束的原始活力。`}
        ...
        <div className="space-y-8">
          <Section title="1. 景点介绍">
              <p className="text-gray-700 leading-relaxed mb-4">{`你绝不会想到，在波黑这片以战争伤痕和古老石桥闻名的土地上，竟藏着这样一片奔腾的、翡翠般的仙境。车子在干燥的、布满碎石的山路上拐了最后一个弯，闷热的空气里忽然渗入一股沁凉的水汽，紧接着，那如同遥远雷鸣般的轰响便扑面而来。走下缓坡，绕过一片橡树林，眼前豁然开朗——那一刻的震撼，是任何照片都无法承载的。那不是一个瀑布，而是一堵弧形的、宽达百余米的、活生生的绿墙。特雷比扎尼卡河的水流在这里被无数钙华阶地温柔地撕碎，化作千百条银白色的水练，从长满青苔和蕨类的墨绿色岩壁上奔腾跃下，坠入下方那一汪深不见底的、闪烁着魔幻祖母绿光泽的潭水中。`}</p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">{`这里绝非一个仅供远观的景点。它是活的，是深深嵌入当地人生活肌理中的“后花园”。你会看到穿着泳衣的一家老小，在潭边铺开彩色的野餐垫，祖父母在树荫下喝着咖啡，父亲带着儿子从较低的岩石上练习跳水，而少年们则奋力游向瀑布最汹涌的下方，享受水流冲击背部的天然按摩。小贩在岸边支起简易的棚子，烤着滋滋作响的ćevapi（波黑肉卷），空气中飘散着烤肉和新鲜面包的香气。这不是一个被玻璃罩起来的自然保护区，而是一个充满烟火气的、人与自然共享的狂欢地。`}</p>
          ...
          <Section title="2. 基本信息">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <InfoRow label="文化价值" value={`不仅是地质学的活标本，更是波黑南部地区人民世代共享的夏日乐园与精神绿洲。`} />
              </div>
            </div>
            <div className="mt-6 space-y-3">
              ...
              <InfoRow label="门票价格" value={`旅游旺季（通常为5月至9月）门票约为8-10波黑马克（约合4-5欧元）；淡季（4月、10月）可能降价至5波黑马克或无人售票；冬季通常免费。学生、儿童及团体可能有小幅优惠，但政策较为随意，建议备好现金零钱。`} />
          ...
          <Section title="3. 历史背景">
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p className="text-gray-700 leading-relaxed mb-4">{`要讲克拉维察瀑布的故事，就不能只盯着那堵水墙。它的生命线，向上游延伸，紧紧系在一条名为特雷比扎尼卡的河流上。这条河本身就是波黑喀斯特地貌的一个传奇，它并非一直在地表奔腾，而是时隐时现，像一条顽皮的地下银龙。它从遥远的山洞中涌出，流经一段后又潜入地下，在石灰岩的迷宫中穿梭，最后在克拉维察这里找到了一个巨大的出口，或者说，遇到了一道它无法逾越的古老岩障。于是，故事开始了。`}</p>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">{`然而，历史的洪流在20世纪90年代变得无比残酷。波黑战争爆发，这片美丽的土地瞬间沦为前线。瀑布所在的区域曾一度是激烈的交战区，通往这里的道路布满地雷，森林里藏着狙击手。那翡翠般的水潭，曾映照过枪口的火光，轰鸣的水声或许曾掩盖过不详的声响。它从乐园变成了禁区，被恐惧和死亡所封锁。那段岁月在瀑布的岩壁上没有留下直接的弹孔，却在周边社区几代人的记忆里，刻下了深深的伤痕。`}</p>
          ...
          <Section title="6. 住宿小贴士">
            <div className="space-y-6">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">{`夏季（7-8月）是绝对旺季，瀑布周边的住宿非常紧俏，务必提前至少一两个月预订。如果选择住在莫斯塔尔，虽然每天需要约40分钟车程，但晚餐和夜生活选择丰富得多。波黑乡村住宿设施普遍简单，但主人极为热情好客，这是金钱买不到的体验。`}</p>
              </div>
            </div>
          </Section>
          ...
          <Section title="7. 总结感悟">
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-6 rounded-lg">
              <p className="text-gray-700 leading-relaxed mb-4">{`离开克拉维察很久之后，那轰鸣的水声还会时不时在耳边回响。它留给我的，远不止几张美丽的照片或一次凉爽的游泳体验。在波黑，你看了太多被枪弹刻上伤痕的建筑，听了太多沉痛的历史故事，心会不自觉地变得沉重。而克拉维察，就像一场及时而慷慨的救赎。它用最原始、最磅礴的生命力告诉你：看，无论地上的人类经历了什么，地下的水流从未停止奔腾，苔藓仍在岩石上生长，阳光依然会把水雾变成彩虹。时间在这里有着截然不同的尺度，不是以世纪或战争为计，而是以碳酸钙沉积一毫米、以水流打磨一块圆石为计。`}</p>
              <p className="text-gray-700 leading-relaxed mb-4">{`在这个一切都被过度规划、过度解读的世界里，克拉维察瀑布保持了一种珍贵的“野生感”和“平民性”。它没有被栅栏围起来，没有禁止触摸的牌子，没有昂贵的观景咖啡厅。它依然是一个你可以跳进去、大喊大叫、和陌生人分享一块面包的地方。这种毫不矫饰的接纳，这种人与自然毫无隔阂的互动，在今天显得如此奢侈和动人。它提醒我们，旅行的最高境界，或许不是收集了多少个“必打卡”的地标，而是有多少次，你真正地融入了一片风景，成为它呼吸的一部分。所以，如果你也渴望在旅途中找到一种纯粹的、充满力量的快乐，那么请一定来波黑，来克拉维察。让那翡翠般的潭水，洗去的不仅仅是夏日的暑气，还有积攒在心头已久的尘埃。`}</p>
            </div>
          </Section>
