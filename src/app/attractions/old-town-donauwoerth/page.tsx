...
export const metadata: Metadata = {
  ...
  description: '说实话，在踏上多瑙沃特古城那些被岁月磨得发亮的鹅卵石路之前，我完全没料到它会如此迷人。我的第一印象来自气味——那是一种混合了老木头、潮湿石墙、远处面包房飘来的黄油香，还有从多瑙河与莱希河方向吹来的、带着水汽的清风的复杂气息。这气味一下子就抓住了你，告诉你：这里的故事，是沉淀下来的，是有分量的。
视觉...',
}
