...
export const metadata: Metadata = {
  title: '特拉夫尼克旅游攻略：波斯尼亚和黑塞哥维那“维齐尔之城”与彩色清真寺深度漫游指南',
  description: '探索波斯尼亚和黑塞哥维那Travnik（特拉夫尼克）的奥斯曼帝国风情。本攻略带你深度游彩色清真寺、古堡，提供一日游路线与避坑指南，感受真正的“维齐尔之城”。',
}
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <Breadcrumb
          items={[
            ...
            { label: '中波斯尼亚州', href: '/destinations/bosnia-and-herzegovina' },
            { label: '特拉夫尼克', href: '/attractions/travnik' },
          ]}
        />

        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{`特拉夫尼克・Travnik・波斯尼亚和黑塞哥维那・中波斯尼亚州`}</h1>
          <p className="text-lg text-gray-600 mb-6">
            {`嘿，朋友！如果说萨拉热窝是波斯尼亚和黑塞哥维那跳动的心脏，那么特拉夫尼克，就是它一段被琥珀封存起来的、带着香料与咖啡香气的旧梦。这座被誉为“维齐尔之城”的山城，完美保留了奥斯曼帝国的魂魄——彩色琉璃瓦在阳光下闪烁，宣礼塔的剪影映衬着背后的荒芜山崖，城堡的巨石墙沉默地讲述着几个世纪的权力更迭。今天这份特拉夫尼克自由行指南，就是你的时光机钥匙。我们不赶景点，而是教你如何像当地人一样，在这里“浪费”一整天：在百年咖啡馆发个呆，跟着石板路的指引去发现角落里的惊喜，最后在山顶古堡等待一场金色日落。跟着我这份私藏旅游攻略，躲开旅行团的人潮，去触摸巴尔干半岛最生动、最斑斓的一页历史吧。`}
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <Section title="2. 基本信息">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <InfoRow label="文化价值" value={`对于现代特拉夫尼克人而言，这些建筑和历史不仅是旅游名片，更是身份认同的根源。这里的生活节奏依然带着奥斯曼时代的遗韵：男人们在老集市旁的咖啡馆里，用着铜制咖啡壶（džezva）慢悠悠地喝着波斯尼亚咖啡，一聊就是一下午；空气中弥漫着烤肉（ćevapi）和 burek（肉馅酥饼）的香气。特拉夫尼克是诺贝尔文学奖得主伊沃·安德里奇的故乡，他的作品深刻描绘了这片土地的文化交织，而这座城市就是他文学的活背景。今天，它作为波斯尼亚和黑塞哥维那联邦的一部分，其完好保存的奥斯曼风貌，成为了这个国家多元文化共存的宁静象征。它不像莫斯塔尔那样充满戏剧性的对比，而是以一种更日常、更生活化的方式，向世人证明：不同的文明印记可以在一座小城里和谐共生，成为人们寻常日子里的风景与底气。`} />
              </div>
            </div>
          ...
          <Section title={`5. 实用避坑指南`}>
            <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-100 text-gray-700 leading-relaxed">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">{`3.  交通与消费须知：从萨拉热窝或莫斯塔尔过来，最方便的是乘坐长途巴士，班次较多。下车后步行即可进入老城，无需额外交通。城内所有景点步行可达。这里物价亲民，但现金为王（使用波斯尼亚和黑塞哥维那马克BAM），很多小餐馆、咖啡馆和家庭店铺不接受信用卡。换汇在老城中心有兑换点，汇率公道。治安整体很好，但集市人多时仍需看管好随身物品。`}</p>
            </div>
          </Section>
          ...
          <Section title="7. 周边延伸探索">
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 text-gray-700 leading-relaxed">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">{`2.  亚伊采（Jajce）：如果时间充裕，可以安排半天前往这座更负盛名的古城（车程约1小时）。亚伊采拥有瀑布穿城而过的奇景，以及同样重要的历史地位（南斯拉夫在此建国）。从特拉夫尼克的奥斯曼风情，切换到亚伊采的中世纪城堡和瀑布轰鸣的自然壮丽，会是一次非常精彩的风格对比之旅，让你对波斯尼亚和黑塞哥维那历史的多元性有更立体的认知。`}</p>
            </div>
          </Section>
