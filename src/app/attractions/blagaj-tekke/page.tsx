        ...
        <div className="space-y-8">
          ...
          <Section title="2. 基本信息">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <InfoRow label="文化价值" value={`它不仅仅是一座宗教建筑，更是一个持续了五个多世纪的灵修、社区生活与自然敬畏之地，展现了波斯尼亚和黑塞哥维那地区伊斯兰教本土化与灵性实践的核心。`} />
              </div>
            </div>
            <div className="mt-6 space-y-3">
              ...
              <InfoRow label="门票价格" value={`入场门票约为5波斯尼亚和黑塞哥维那马克（约合2.5欧元）。学生、儿童及10人以上团队通常可享受半价优惠。门票收入主要用于建筑维护。部分特殊区域或导览游可能需要额外付费。`} />
              <InfoRow label="地址" value={`Blagaj Tekke, Blagaj bb, 88201 Blagaj, Bosnia and Herzegovina`} />
              <InfoRow label="交通方式" value={`从波斯尼亚和黑塞哥维那的主要国际门户——萨拉热窝机场出发，最便捷的方式是租车自驾。沿M17/E73公路向南行驶约2小时即可抵达布拉加伊村，修道院有清晰路标。若使用公共交通，可先从萨拉热窝中央巴士站乘坐频繁发车（约每小时一班）的大巴前往莫斯塔尔，车程约2.5小时。抵达莫斯塔尔后，在车站转乘前往布拉加伊的本地巴士，车次频繁，约20-30分钟即可到达村中心，从巴士站步行至修道院约需10分钟。建议在莫斯塔尔巴士站购买返程票以确保座位。`} />
            </div>
          </Section>
          ...
          <Section title="3. 历史背景">
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">{`而它最严峻的生死考验，是1990年代初的波斯尼亚和黑塞哥维那战争。布拉加伊位于激烈交战的前线附近。炮火曾在这片美丽的山谷中轰鸣。你可以想象，那些白色的墙壁在硝烟中是多么显眼的靶子。然而，或许是冥冥中的庇佑，或许是交战双方对这块圣地残存的一丝敬意，特基亚修道院在战火中受到的直接破坏相对较小。战争结束后，波斯尼亚和黑塞哥维那人开始了艰难的重建，不仅是物质上的，更是精神上的。特基亚的修复成为一项具有象征意义的工作。当地人和来自国内外的捐助者共同努力，小心翼翼地修复了被岁月和忽视磨损的木构件、屋顶和石墙。他们做的不是翻新，而是复原，力求让每一块石头、每一根木梁都讲述真实的历史。`}</p>
...
夏季午后人流最多，若想享受绝对清静，可尝试在早上刚开门或关门前一小时前来，不过光线角度与午后不同。`}
          ...
          <Section title="6. 住宿小贴士">
            <div className="space-y-6">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">{`夏季（6-8月）是波斯尼亚和黑塞哥维那旅游旺季，莫斯塔尔和布拉加伊的优质住宿非常紧俏，务必提前至少1-2个月预订。`}</p>
