    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{`亚伊采・Jajce・波斯尼亚和黑塞哥维那・亚伊采`}</h1>
        ...
        <div className="space-y-8">
          ...
          <Section title="2. 基本信息">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <InfoRow label="文化价值" value={`它是波斯尼亚和黑塞哥维那国家认同的摇篮与象征，其瀑布与城堡的独特结合不仅是自然与人文共生的杰作，更是波斯尼亚、克罗地亚、塞尔维亚等多民族文化层叠交融的立体教科书。`} />
              </div>
            </div>
            <div className="mt-6 space-y-3">
              ...
              <InfoRow label="门票价格" value={`瀑布观景台区域免费参观。进入中世纪要塞内部参观需要门票，价格约为成人5波斯尼亚和黑塞哥维那马克（约2.5欧元），学生及儿童有优惠。门票通常为通票，可能包含城内其他小型博物馆（如亚伊采博物馆、“在旧体制下”博物馆）。当地居民和特定团体可能免费。`} />
              <InfoRow label="地址" value={`Bosanska ulica, Jajce 70101, Bosnia and Herzegovina`} />
              <InfoRow label="交通方式" value={`从波斯尼亚和黑塞哥维那首都萨拉热窝出发最为方便。在萨拉热窝中央汽车站乘坐前往亚伊采的长途巴士，班次频繁，大约每小时一班，车程约为2.5至3小时。车票建议在车站售票窗口直接购买，单程票价约15-20波斯尼亚和黑塞哥维那马克。自驾则是绝佳选择，沿M5公路向西北行驶，约140公里，沿途是连绵起伏的丘陵和田园风光，可以自由控制节奏。亚伊采古城内景点集中，完全可以步行探索。`} />
            </div>
          </Section>
          ...
          <Section title="3. 历史背景">
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">{`奥斯曼人留了下来，他们并没有毁掉城堡，而是加固它，并依照自己的生活方式在城堡下方建设。于是，你看到了今天老城区的模样：窄巷、石屋、庭院、以及必不可少的清真寺和土耳其浴室（哈马姆）的遗迹。瀑布依然奔流，但城市里响起了宣礼塔的唤拜声。这种文化的层叠，在1895年奥匈帝国吞并波斯尼亚和黑塞哥维那后，又加上了新的一笔。帝国带来了秩序、规划与现代工程技术。他们修建了贯穿城市的主路，建造了规整的行政大楼，甚至为瀑布安装了最早的观景灯饰。你会看到一些黄白相间的、带有一点新古典主义风格的建筑，安静地站在奥斯曼老屋旁边，毫不违和。`}</p>
