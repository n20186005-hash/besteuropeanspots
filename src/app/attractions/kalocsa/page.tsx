      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <Breadcrumb
          items={[
            ...
            { label: '考洛乔', href: '/destinations/hungary' },
            { label: '考洛乔老城', href: '/attractions/kalocsa' },
          ]}
        />

        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">考洛乔老城</h1>
          <p className="text-xl text-gray-600 mb-4">Kalocsa</p>
