      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <Breadcrumb
          items={[
            ...
            { label: '南特', href: '/destinations/france' },
...
更重要的是，这个奇幻世界并非悬浮于空中，它深深地扎根在南特这座城市的肌理里。本地人带着孩子来这里，就像去公园一样平常。你会看到头发花白的老人指着巨大的联动装置，跟孙子讲述过去这里是如何制造出远洋巨轮的。机械岛用一种极致浪漫的方式，缝合了这座城市因造船业衰落而留下的心理伤疤，将沉重的工业遗产，变成了承载无限想象力的飞毯。它不是对过去的简单怀念，而是一场面向未来的、欢快的庆祝。`}
        ...
        <div className="space-y-8">
          ...
          <Section title="1. 景点介绍">
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "我第一次听说南特机械岛时，脑子里浮现的是游乐园的过山车和闪亮的霓虹灯。但当我真正走出南特火车站，沿着卢瓦尔河向旧船厂区走去时，扑面而来的是一种完全不同的气息。空气里没有糖霜的甜腻，而是一种混合了河水微腥、远处传来的淡淡机油味，以及秋天法国梧桐落叶的泥土气息。巨大的旧工业起重机像沉默的钢铁恐龙骨架矗立在河边，而你的目的地，就藏在这些历史的巨人之间。" }} />
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "然后，你听到了。那不是音乐，是一种低沉、缓慢、富有韵律的“咯吱……吭……哧……”声，像极了某种巨兽的呼吸与心跳。循着声音转过一个街角，你就看到了它——那头十二米高、八米宽的机械巨象。它正载着满背惊叹的游客，在花岗岩铺就的广场上漫步，巨大的木制耳朵缓缓扇动，钢骨构成的象鼻灵活地卷曲、喷出带着凉意的水雾。阳光穿透水雾，折射出小小的彩虹。那一刻，你突然理解了“蒸汽朋克”这个词不再是书本上的概念，而是一种可触摸、可乘坐、甚至会对你眨眨眼的现实。你仿佛站在了儒勒·凡尔纳（他正是南特人）的笔记本里，或者列奥纳多·达·芬奇那未完工的草稿边。" }} />
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "这里最迷人的不是机械的庞大，而是它鲜活的“生命感”。走进那栋由旧造船厂车间改造的“机械长廊”，你就像进入了一个巨兽的孵化器。天花板下悬挂着半成品的苍鹭骨架，工人们（他们自称“机械师”）正拿着工具，像外科医生一样为一只有着金属羽毛的蜻蜓调试关节。空气里满是松木、亚麻籽油和焊接金属的独特味道。你可以凑近看每一个齿轮的咬合，触摸那些被手工打磨得温润的木制部件。这里没有“请勿触摸”的冰冷警告，取而代之的是鼓励你去转动曲柄、拉动杠杆，亲身感受机械传动带来的奇妙力量。这种参与感，让冷硬的机械拥有了温度。" }} />
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "更重要的是，这个奇幻世界并非悬浮于空中，它深深地扎根在南特这座城市的肌理里。本地人带着孩子来这里，就像去公园一样平常。你会看到头发花白的老人指着巨大的联动装置，跟孙子讲述过去这里是如何制造出远洋巨轮的。机械岛用一种极致浪漫的方式，缝合了这座城市因造船业衰落而留下的心理伤疤，将沉重的工业遗产，变成了承载无限想象力的飞毯。它不是对过去的简单怀念，而是一场面向未来的、欢快的庆祝。" }} />
          </Section>
          ...
          <Section title="3. 历史背景">
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "要理解机械岛的诞生，你得先回到二十世纪中叶的南特。那时的卢瓦尔河畔，可不是现在这般充满艺术气息。巨大的造船厂里灯火通明，敲打钢铁的轰鸣声响彻云霄，这里是法国最重要的造船基地之一，成千上万的工人在这里挥洒汗水，建造着驶向世界各地的船舶。南特的命运与海洋、与钢铁紧紧捆绑。然而，随着全球化产业转移，上世纪七八十年代，造船业无可挽回地衰落了。船厂接连关闭，巨大的吊机和厂房被废弃，生锈的钢铁骨架对着河流，像一个个被时代遗弃的巨兽。整个街区陷入了漫长的沉寂与迷茫，那是工业革命后许多城市共同的阵痛。" }} />
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "转机源于一个天马行空的艺术构想。时间来到新世纪之初，南特市政府决心彻底活化这片巨大的滨水工业遗址。他们不是要推倒重建高楼，而是要注入一个独一无二的灵魂。这时，两位关键人物登场了：弗朗索瓦·德拉罗齐埃和皮埃尔·奥雷菲斯。他们一个是剧场导演，一个是机械设计师，共同痴迷于“移动剧场”和“街头巨型装置”。他们的灵感源泉直接锚定在南特最骄傲的两位儿子身上：科幻小说之父儒勒·凡尔纳，以及虽非南特人却代表机械美学巅峰的列奥纳多·达·芬奇。一个想法逐渐成型：为何不创造一个凡尔纳笔下的世界，用达·芬奇草图中的机械原理，制造出真实存在的、可供人乘坐嬉戏的巨兽呢？" }} />
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "这个听起来像疯子的点子，却被市政当局勇敢地采纳了。2004年，项目正式启动。团队没有选择现代化的工厂，而是特意入驻了荒废的“大西洋造船厂”旧车间。他们把这里变成了一个开放式的创作实验室。你想象一下那个场景：在充满历史尘埃的厂房里，现代的木匠、焊工、雕刻师和工程师们，围着图纸和模型，争论着一只机械蚂蚁的腿部该用什么样的联动结构，或者一条机械蝠鲼的翅膀如何扇动才能既优美又符合流体力学。所有机械的核心，都遵循着达·芬奇时代就有的原理：齿轮、连杆、曲轴、滑轮，没有电子芯片和复杂的编程，全靠精妙的机械传动。这既是对古典智慧的致敬，也赋予了这些造物一种原始而坦诚的生命力。" }} />
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "2007年，第一个震撼世界的明星——机械大象——正式亮相。当这个重达48吨的庞然大物迈出第一步，从工坊走向广场时，整个南特都沸腾了。它不仅仅是一个景点，更成为了一个文化符号，一个宣告城市从工业“制造”转向创意“智造”的宣言。随后，奇幻的“海洋世界旋转木马”在2012年登场，这不是普通的旋转木马，而是一座高达25米、拥有三层海底世界的机械海洋馆，你可以骑乘机械螃蟹、驾驶机械鹦鹉螺号，甚至置身于巨大的机械翻车鱼腹中旋转。每一个新成员的加入，都像是为这个持续生长的机械生态圈添上了一块瑰丽的拼图。" }} />
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "如今，机械岛的故事还在继续。它已经从一个项目，演变成一个持续创作和扩张的生态系统。新的机械生物在不断被设计和制造，旧船厂的其他区域被改造成创意园区、餐厅和酒吧。它吸引着全球的艺术家和工程师前来驻留合作。这里发生过最动人的一幕或许是：当年造船厂的老工人们回访此地，他们抚摸着机械巨象的钢铁支架，眼中含泪，不是悲伤，而是看到自己曾经工作的场所、自己熟悉的钢铁与齿轮，以一种如此诗意和快乐的方式获得了新生。机械岛用它的奇幻叙事，完成了一场跨越时空的和解与传承。" }} />
            </div>
          </Section>
          ...
          <Section title={`6. 住宿与餐饮推荐`}>
            <div className="space-y-6">
              ...
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "机械岛所在的“Ile de Nantes”岛近年来发展迅速，遍布创意工作室和精品店，晚上很安全且有生活气息。如果想体验更古典的南特老城风情，可以选择住在布列塔尼公爵城堡附近，乘坐电车过来也很方便。旺季（夏季和学校假期）住宿非常紧张，提前两个月预订是明智之举。" }} />
              </div>
            </div>
          </Section>
          ...
          <Section title="7. 总结感悟">
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-6 rounded-lg">
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "离开南特很多天后，我脑子里挥之不去的，不是某个具体的机械形象，而是一种感觉——一种关于“可能”的兴奋感。在我们这个时代，科技日益隐形和抽象，一切仿佛都由看不见的代码和算法驱动。但机械岛反其道而行，它把所有的奥秘都袒露给你看：你看得见每一根连杆的推动，听得见每一个齿轮的咬合，摸得到木材的纹路和钢铁的冰凉。它用一种近乎笨拙的诚实，重建了人与机械之间最原初的、充满好奇与敬畏的联系。它告诉你，想象力可以如此具体，如此坚实，甚至可以承载你的体重，带你去往一个八米高的童话视角。" }} />
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "这个地方之所以必须列入清单，远不止因为它独特、好玩、拍照好看。更因为，它代表了一种极其珍贵的生活态度：用无边的浪漫去拥抱沉重的历史，用孩童般的玩乐心去解构复杂的现实。南特没有试图忘记它作为工业重镇的过去，而是为那段钢铁记忆，举办了一场盛大、持续、且欢迎所有人参与的嘉年华。在这里，你会被提醒，无论年纪多大，内心深处那个渴望探索、渴望动手创造、渴望看到神话成真的小孩，一直都在。前往机械岛，不仅仅是一次旅行，更是一次对自身想象力的朝圣与重启。在那些咯吱作响的齿轮交响乐中，你会找回一种久违的、确信世界仍然充满奇妙可能的快乐。" }} />
            </div>
          </Section>
