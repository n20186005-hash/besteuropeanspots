      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <Breadcrumb
          items={[
            ...
            { label: '林堡省雷克姆镇', href: '/destinations/belgium' },
            { label: '旧雷克姆', href: '/attractions/oud-rekem' },
          ]}
        />

        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{`旧雷克姆・Oud-Rekem・比利时・林堡省雷克姆镇`}</h1>
          <p className="text-lg text-gray-600 mb-6">
            {`车子拐下主干道，穿过一片平平无奇的现代住宅区，仿佛只是要去拜访某个郊区的朋友。然后，毫无预兆地，一座古老的石桥将你引渡到另一个时空。车轮碾过第一块中央广场的鹅卵石时，那种“抵达”感是轻柔却确定的——喧嚣被抛在身后，时间陡然慢了下来。这就是旧雷克姆给你的第一课：它不张扬，只是静静地在那里等着，等你自己发现。
空气里有股好闻的味道，是潮湿的泥土混合着远处面包房飘来的黄油香气，还有老砖石在阳光下散发出的、类似旧书的温和气味。你的眼睛需要几秒钟来适应：这里没有刺眼的颜色，整个调色板是砖红、陶土黄、砂岩灰和木窗框的墨绿，像一幅被岁月打磨柔和的油画。声音是极简的：自己的脚步声在石板上回响，偶尔有自行车铃铛的叮铃声，某扇门后传来模糊的电视声响，还有无处不在的、林堡省乡村那种深邃的宁静，几乎能听到风穿过屋顶瓦片的声音。
最打动人的，是这里依然“活着”。那栋有着华丽山墙的17世纪建筑，可能是一位律师的办公室；广场角落的漂亮小楼，窗户上贴着瑜伽课程表。你看到居民在自家门前的长椅上读报，冲你点头微笑，仿佛你不是闯入的游客，只是偶尔路过的邻居。历史在这里不是被圈起来供奉的标本，而是日常生活的背景墙。这种真实感，让每一块砖、每一扇门都充满了温度。
它的核心魅力，就在于这种完美的平衡感——建筑学上的完美与社区生命力的完美结合。你感受到的不是历史的沉重，而是一种被精心维护的、从容不迫的优雅。它告诉你，美不必宏大，完整与和谐本身，就是一种震撼人心的力量。`}
          </p>
        </div>
          ...
          <Section title="2. 基本信息">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <InfoRow label="中文名称" value={`旧雷克姆`} />
                <InfoRow label="英文名称" value={`Oud-Rekem`} />
                <InfoRow label="正式名称" value={`Oud-Rekem`} />
              ...
              <div className="space-y-4">
                ...
                <InfoRow label="建筑风格" value={`以西班牙统治时期晚期和早期巴洛克风格为主导，混合了本土的莫桑河地区民居特色，形成了独特而和谐的法兰德斯乡村古典风貌。`} />
            ...
            <div className="mt-6 space-y-3">
              ...
              <InfoRow label="地址" value={`Oud-Rekem, 3621 Rekem, Belgium`} />
              <InfoRow label="交通方式" value={`最近的国际机场是比利时列日机场或荷兰马斯特里赫特亚琛机场，但航班较少。最方便的大枢纽是布鲁塞尔国际机场。从布鲁塞尔中央火车站乘坐IC城际列车前往亨克站，车程约1小时20分钟，班次频繁。抵达亨克后，转乘47路或48路公交车，在“Rekem Kerk”站下车，车程约25分钟，每小时约1-2班。更推荐自驾，从亨克或马斯特里赫特驱车前往仅需15-20分钟，村庄外围设有免费停车场，然后步行进入石板路区域。这里没有喧嚣的旅游大巴，宁静本身就是交通的一部分。`} />
            </div>
          </Section>
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <div className="text-sm text-blue-800 bg-blue-100 p-3 rounded">
                  <strong>建议：</strong>{`村庄内几乎所有路面都是古老的鹅卵石，请务必穿一双舒适且鞋底有一定厚度的步行鞋，高跟鞋在这里简直是“刑具”。尊重居民的隐私，透过窗户向内张望是不礼貌的，如果看到门口有“私人住宅”的牌子，请不要进入院子。这里几乎没有大型旅游商店或喧闹的餐厅，只有一两家咖啡馆和家庭餐馆，价格朴实，请享受这种纯粹的本地氛围，并记得在下午五点前解决晚餐，因为很多小店关门很早。`}
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-700 mb-2">{`把车停在村庄边缘免费的“P+Rekem”停车场，沿着默兹支流上的古石桥慢慢走进去，让那座砖石塔楼成为你穿越时空的入口。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 2 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`直接前往小巧却信息丰富的游客中心，拿一份手绘地图，听工作人员用带林堡口音的英语热情介绍今天村里有没有特别的活动或临时开放的古宅。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 3 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`让中央的“Grote Markt”大广场成为你的客厅，先绕着广场走一圈，细细欣赏每一栋建筑山墙上各不相同的巴洛克纹饰和日晷，想象三百年前这里的市集光景。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 4 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`一定要推开圣彼得教堂那扇厚重的木门，走进去感受由无数烛光、金色装饰与幽暗静谧共同营造出的、极其典型又动人的法兰德斯乡村教堂氛围。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 5 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`从广场任意选一条放射状的小巷钻进去，比如Kloosterstraat，专注地看着脚下被岁月磨得温润发亮的鹅卵石路面和两旁住户窗台上精心打理的天竺葵。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 6 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`找到并参观旧城堡（现为“文化城堡”），即使不看展览，也务必在它的庭院和花园里走走，从伯爵家族的视角回望整个小镇的屋顶轮廓线。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 7 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`如果开放，去探访一下“阿佩尔托伦博物馆”，这个位于古老城墙塔楼里的小型博物馆用有趣的陈列讲述着村庄从史前到近代的层层历史。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 8 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`留出至少半小时完全无所事事的时间，在广场边的咖啡馆“In den Ouden Vogelstruys”外找把椅子坐下，点一杯本地啤酒或咖啡，纯粹地观察光影在古老墙面的移动。`}</p>
                </div>
              </div>
            </div>
          </Section>
          ...
          <Section title="5. 拍照机位">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">1. {`大广场东侧建筑阴影下`}</h4>
                  <p className="text-sm text-gray-700">{`下午三四点的斜阳将对面建筑的巴洛克山墙照得金光灿灿，此时站在广场东侧的阴影里拍摄，能获得明暗对比强烈、色彩饱和度极高的全景画面。`}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">2. {`Kloosterstraat小巷深处`}</h4>
                  <p className="text-sm text-gray-700">{`清晨八点至九点，阳光低角度射入狭窄的小巷，在红砖墙和鹅卵石上拉出长长的光影，蹲下放低机位，可以拍出深邃而富有引导感的纵深感照片。`}</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">3. {`旧城堡后花园的土坡上`}</h4>
                  <p className="text-sm text-gray-700">{`这里是村庄的制高点之一，全天皆可，但尤以黄昏时分最佳，可以拍摄到圣彼得教堂塔楼与层层叠叠的砖瓦屋顶沐浴在暖金色夕阳下的经典全景。`}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">4. {`河畔石桥回望视角`}</h4>
                  <p className="text-sm text-gray-700">{`站在进入村庄的古石桥上，向村庄方向回望，可以将水面的倒影、石桥的拱洞与远处的塔楼一同纳入构图，营造出画卷般的入口意象，清晨有薄雾时效果绝佳。`}</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">5. {`某扇彩色的古老大门前`}</h4>
                  <p className="text-sm text-gray-700">{`旧雷克姆的门是一大特色，墨绿、深蓝或暗红色的木门配上黄铜门环，选择一扇你最喜欢的，在正午阳光直射时拍摄门扉的细节和质感，阴影会让雕刻纹理格外突出。`}</p>
                </div>
              </div>
            ...
            <div className="mt-6 p-4 bg-purple-50 border-l-4 border-purple-400">
              ...
              <ul className="text-sm text-purple-700 space-y-1">
                <li>• {`使用偏振镜可以有效减少古老砖石表面的反光，让红色更加浓郁深沉。拍摄居民或他们的房屋时，请先微笑示意并获得默许，比利时人通常友善但注重隐私。飞无人机在当地是严格受限的，尤其在历史建筑上空，未经特别许可请不要起飞。`}</li>
              </ul>
            </div>
          </Section>
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-blue-800">{`“Hotel Ter Driezen”是一家由家族经营的传统酒店，本身就是一栋有故事的老建筑，房间朴实温馨，早餐的奶酪和火腿来自隔壁农场，老板能给你讲一整夜的老雷克姆传说。`}</p>
                </div>
                <div className="bg-green-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-green-900 mb-2">{`设计感隐居`}</h4>
                  <p className="text-sm text-green-800">{`“Kasteelhoeve Wurfeld”是坐落在附近田野间的一座经过现代设计的古老农庄，房间宽敞极简，拥有无敌的田园视野，适合想要绝对宁静、并愿意短途驾车进出村庄的旅行者。`}</p>
                </div>
                <div className="bg-yellow-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-yellow-900 mb-2">{`马斯特里赫特都市基营`}</h4>
                  <p className="text-sm text-yellow-800">{`如果你偏爱夜生活与更多餐饮选择，可以住在15分钟车程外的荷兰马斯特里赫特古城，那里有从青年旅舍到五星酒店的完整谱系，白天再来雷克姆享受静谧。`}</p>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-purple-900 mb-2">{`林堡乡村民宿网络`}</h4>
                  <p className="text-sm text-purple-800">{`利用“Bed & Breakfast Vlaanderen”网站预订村庄内或周边3公里内的民宿，这些民宿多是村民的自宅，能让你最深入地体验本地日常，早晨在花园里和主人一起喝咖啡。`}</p>
                </div>
              </div>
