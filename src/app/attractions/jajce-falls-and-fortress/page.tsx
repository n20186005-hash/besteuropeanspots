          ...
          <Section title="2. 基本信息">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <InfoRow label="文化价值" value={`它是波斯尼亚和黑塞哥维那这个多民族、多宗教国家历史层积的缩影，象征着自然力量与人类文明之间持续数百年的对话与依存。`} />
              </div>
            </div>
            <div className="mt-6 space-y-3">
              ...
              <InfoRow label="门票价格" value={`进入瀑布下方观景区域及城堡主体通常需要购买联票。成人票价约10-15波斯尼亚和黑塞哥维那马克（BAM），学生及儿童享有折扣。门票通常在城堡入口处或老城区的游客中心购买。部分外围观景步道免费。`} />
              <InfoRow label="地址" value={`瀑布与城堡区域，Jajce 70101， 波斯尼亚和黑塞哥维那`} />
              <InfoRow label="交通方式" value={`从首都萨拉热窝出发：在萨拉热窝中央汽车站乘坐前往亚伊采的大巴，班次频繁，车程约3-3.5小时，沿途是蜿蜒的山路和田园风光。从克罗地亚萨格勒布出发：也有直达大巴，车程约4-5小时。抵达亚伊采汽车站后，小镇规模不大，瀑布和城堡是绝对地标，从车站步行约15-20分钟即可抵达老城区和瀑布边缘。如果行李多，可以叫一辆当地的出租车，价格非常实惠。建议提前一天确认大巴时刻表，波斯尼亚和黑塞哥维那的长途交通有时会有临时变动。`} />
            </div>
          </Section>

          <Section title="3. 历史背景">
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p className="text-gray-700 leading-relaxed mb-4">{`让我们把时钟拨回到中世纪。早在15世纪，亚伊采就是波斯尼亚王国的心脏地带。这里的城堡可不是为了看风景建的，它地势险要，易守难攻，是王国最后的堡垒之一。1421年，波斯尼亚国王斯特凡·特弗尔特科二世甚至在这里加冕，你可以想象当时城堡内举行的盛大仪式，与墙外瀑布的轰鸣交织在一起。那时候，小镇因铜矿和铁匠行会而繁荣，工匠们的锤击声或许曾与瀑布声争鸣。城堡不仅是王权的象征，也守护着山下繁忙的市集和不同信仰的居民——天主教堂、东正教堂和后来的清真寺相继出现，留下了最早的“波斯尼亚和黑塞哥维那式”多元痕迹。`}</p>
...
小镇许多小餐馆和纪念品店可能只收现金（波斯尼亚和黑塞哥维那马克或欧元），信用卡不一定畅通，提前备好零钱。
尊重当地习俗，尤其是在参观老墓园（无论是中世纪的Stećci墓碑还是奥斯曼时期的墓葬）时，保持肃静。`}
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-700 mb-2">{`离开前，在瀑布顶端河畔的某家露天咖啡馆坐下，点一杯波斯尼亚和黑塞哥维那咖啡，就这样看着河水在你眼前几米处平静流淌，然后突然消失，坠入虚空。`}</p>
                </div>
              </div>
            </div>
          </Section>
          ...
          <Section title="7. 总结感悟">
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-6 rounded-lg">
              <p className="text-gray-700 leading-relaxed mb-4">{`离开亚伊采好久了，但那水声好像还留在耳朵里。它不是那种需要你屏息凝神、顶礼膜拜的宏伟古迹，而是一种更持久、更生活化的存在。它让我想起，历史不总是陈列在玻璃柜里的死物，它可以像那条普利瓦河一样，是活的，一直在流淌、奔腾、坠落，然后汇入更广阔的河流。城堡的石头是沉默的编年史，而瀑布的水是永不疲倦的讲述者。在这里，你能触摸到波斯尼亚和黑塞哥维那这个国家的复杂脉搏——它的坚韧、它的伤痕、它的美丽，以及它那在各种文明冲刷下依然保持独特性的生命力。`}</p>
