...
export const metadata: Metadata = {
  ...
  description: '波斯尼亚和黑塞哥维那Ljubuški深度游攻略，揭秘悬崖上的赫尔采格·斯捷潘城堡废墟，俯瞰特雷比沙特河谷的震撼全景。小众景点推荐与完整避坑指南。',
}
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{`柳布什基（赫尔采格·斯捷潘城堡）・Ljubuški (Herceg Stjepan Castle)・波斯尼亚和黑塞哥维那・西黑塞哥维那州`}</h1>
          <p className="text-lg text-gray-600 mb-6">
            {`嘿，朋友，如果你厌倦了人挤人的打卡地，想找一处能让心跳和呼吸都慢下来的秘境，那今天这份**柳布什基私藏旅游攻略**，就是为你准备的。它藏在波斯尼亚和黑塞哥维那西南部，一个名字有点绕口却充满故事感的地方——西黑塞哥维那。我们的主角，不是繁华的城镇，而是一座盘踞在险峻石灰岩山巅、几乎被野草和时光吞噬的城堡废墟：赫尔采格·斯捷潘城堡。它将带给你最强烈的对比体验：一边是攀登时脚下碎石滚落的荒芜与孤独，另一边是登顶后，眼前特雷比沙特河谷（Trebižat）那片铺展开的、令人屏息的富饶绿野。作为你的专属向导，这份**柳布什基自由行指南**，会带你安全地完成这场时空穿梭，告诉你如何触摸那些冰冷的石头里沉睡的热血历史，以及怎样避开所有让旅行扫兴的坑。相信我，这绝对是一趟后劲十足的**深度游**。`}
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <Section title="1. 景点介绍">
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "嘿，朋友，如果你厌倦了人挤人的打卡地，想找一处能让心跳和呼吸都慢下来的秘境，那今天这份<strong>柳布什基私藏旅游攻略</strong>，就是为你准备的。它藏在波斯尼亚和黑塞哥维那西南部，一个名字有点绕口却充满故事感的地方——西黑塞哥维那。我们的主角，不是繁华的城镇，而是一座盘踞在险峻石灰岩山巅、几乎被野草和时光吞噬的城堡废墟：赫尔采格·斯捷潘城堡。它将带给你最强烈的对比体验：一边是攀登时脚下碎石滚落的荒芜与孤独，另一边是登顶后，眼前特雷比沙特河谷（Trebižat）那片铺展开的、令人屏息的富饶绿野。作为你的专属向导，这份<strong>柳布什基自由行指南</strong>，会带你安全地完成这场时空穿梭，告诉你如何触摸那些冰冷的石头里沉睡的热血历史，以及怎样避开所有让旅行扫兴的坑。相信我，这绝对是一趟后劲十足的<strong>深度游</strong>。" }} />
          </Section>
          ...
          <Section title="2. 基本信息">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <InfoRow label="历史地位" value={`别看它如今这般寂寥残破，在15世纪，这座城堡可是跺跺脚就能让整个地区震三震的存在。它的名字“赫尔采格·斯捷潘”，源自当时波斯尼亚和黑塞哥维那的实际统治者——赫尔采格（公爵）斯捷潘·武克契奇·科萨查。在那个奥斯曼帝国铁蹄不断西扩、基督教世界奋力抵抗的动荡年代，这座城堡就是斯捷潘大公权力与威望的象征，也是守护他领地的关键军事堡垒。它矗立在至关重要的交通和战略要冲，俯瞰着下方丰饶的河谷与通往亚得里亚海的道路。城堡见证了中世纪波斯尼亚王国的最后辉煌，也亲历了随后被奥斯曼帝国吞并的历史转折。它不仅仅是一堆石头，更是波斯尼亚本地贵族政权在欧洲东南部这片复杂棋局上，落下的一枚沉重而悲壮的棋子。当帝国更迭，它的军事价值消退，便被逐渐遗忘在群山之中，成了今天这幅模样——一个被历史洪流冲刷后留下的、充满隐喻的骨架。`} />
                ...
                <InfoRow label="文化价值" value={`对于今天的柳布什基当地人而言，这座废墟远不止是一个旅游景点。它是一个地标，一个国家的记忆锚点，象征着这片土地上曾经有过的独立与强大。它提醒着人们关于波斯尼亚自身复杂的历史层次——既非纯粹的东方，也非纯粹的西方。在现代波斯尼亚和黑塞哥维那人的集体情感中，这样的中世纪遗址是他们民族历史连续性和独特性的重要证明。同时，它也成为一种精神象征：那种在绝境中屹立（literally建在悬崖上）、在衰败后依然以另一种形式（作为风景和历史遗迹）滋养后人的韧性。近年来，随着户外运动和深度旅游的兴起，城堡吸引了越来越多的徒步爱好者、历史迷和摄影师。它不再仅仅是历史课本上的名字，而是变成了一个活化的文化空间，人们来这里徒步、冥想、看日落、思考历史，它以一种安静而强大的方式，持续参与并塑造着当地的文化认同和社区自豪感。`} />
              </div>
            </div>
          ...
          <Section title={`6. 柳布什基周边住宿与美食攻略`}>
            <div className="space-y-6">
              ...
              <li className="text-gray-700 leading-relaxed mb-2 ml-4 list-disc" dangerouslySetInnerHTML={{ __html: "<strong>Ćevapi</strong>：波斯尼亚和黑塞哥维那国菜，小牛肉或混合肉馅制成的香嫩小肉肠，通常配以新鲜松软的“索姆恩”（Somun）面包、生洋葱和酸奶油。在特雷比沙特河畔的餐厅享用，风味最佳。" }} />
