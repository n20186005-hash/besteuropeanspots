    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{`亨宁斯韦尔渔村・Henningsvær・挪威・诺尔兰郡`}</h1>
          <p className="text-lg text-gray-600 mb-6">
            {`当渡轮缓缓靠近罗弗敦的心脏地带，首先闯入视线的不是大陆，而是一片散落在翡翠色海面上的积木般的小岛。这就是亨宁斯韦尔给你的第一印象——一个仿佛被巨人随意撒在挪威海上的梦境。海风带着一股清冽的咸味和一丝隐约的、来自远方冰川的寒气，扑面而来，瞬间洗刷掉所有长途旅行的困倦。发动机的轰鸣被海鸥悠长的鸣叫替代，它们像白色的哨兵，在红、黄、白色的木屋上空盘旋。
沿着蜿蜒的堤道走进村子，时间好像自动调慢了。耳边是海浪轻拍礁石的哗啦声，是绳索摩擦木桩的吱呀声，是某扇木门开合时清脆的门铃铛响。脚下是湿漉漉、反着光的石板路，缝隙里长着顽强的苔藓。那些著名的木屋就紧紧地挨在一起，漆色在北极光长时间的曝晒下有些斑驳，却更显真实。你会看到窗台上精心摆放的天竺葵，在短暂的夏季里开得轰轰烈烈；会看到晾晒的渔网和雨靴随意地靠在墙边。这里不是一个博物馆式的景点，而是一个仍然呼吸、带着鱼腥味和生活温度的活着的渔村。
然而，亨宁斯韦尔最摄人心魄的一笔，是那个被称为“世界最美”的足球场。它不在陆地上，而是伸向大海，三面被深邃的挪威海环绕。站在场边，你会感到一种奇妙的眩晕：脚下是绿茵，几步之外便是深不可测的墨蓝色海水和嶙峋的黑色礁石。想象一下，在午夜太阳的余晖下，一群少年在这里追逐足球，背景是覆雪的山峰和归航的渔船——这大概是体育运动与自然景观最诗意的结合了。它完美诠释了这里的精神：在最极限的环境里，创造最平凡而热烈的快乐。`}
          </p>
        </div>
          ...
          <Section title="2. 基本信息">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <InfoRow label="中文名称" value={`亨宁斯韦尔渔村`} />
                <InfoRow label="英文名称" value={`Henningsvær`} />
                <InfoRow label="正式名称" value={`Henningsvær`} />
              ...
              <div className="space-y-4">
                ...
                <InfoRow label="建筑风格" value={`传统的挪威沿海木结构建筑，实用主义与鲜明色彩的完美结合。`} />
            ...
            <div className="mt-6 space-y-3">
              ...
              <InfoRow label="地址" value={`Henningsvær, 8312 Henningsvær, Norway`} />
              <InfoRow label="交通方式" value={`最近的机场是博德机场（BOO）或埃沃内斯机场（EVE）。从博德出发最经典：在博德码头乘坐前往莫斯肯内斯的渡轮（约3-4小时，穿越壮丽的韦斯特峡湾），抵达后转乘当地巴士或提前预订出租车，约30分钟车程可到亨宁斯韦尔。从埃沃内斯（纳尔维克附近）出发则需驾车穿越整个罗弗敦群岛，沿E10公路行驶约3小时，沿途风景绝美。自驾是游览罗弗敦最灵活的方式，但冬季路况复杂需谨慎。村内道路狭窄，建议将车停在村口停车场步行探索。`} />
            </div>
          </Section>
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <div className="text-sm text-blue-800 bg-blue-100 p-3 rounded">
                  <strong>建议：</strong>{`夏季是旅游旺季，尽量避开中午至下午的游船团高峰期，独享宁静。冬季来访务必穿戴专业的防滑防水鞋和防风保暖衣物，路面结冰非常危险。尊重当地居民隐私，拍摄房屋内部或居民特写前请先征得同意。`}
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-700 mb-2">{`从主停车场出发，先别急着进村，绕到海边找一块巨大的礁石坐下，静静看着海鸥掠过水面和停泊在港湾里的彩色渔船，让身心先适应这片北极海的气息。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 2 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`沿着主路走进迷宫般的木屋小巷，任由自己迷路，用手触摸那些饱经风霜的木质墙壁，抬头寻找每一扇窗户里透露出的温馨灯光和生活细节。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 3 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`找到那座著名的亨宁斯韦尔足球场，不一定要走到中心，可以坐在边缘的岩石上，感受海风，看当地人训练或孩子玩耍，想象一场在海天之间的比赛。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 4 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`探访由老鱼仓改造的“Henningsvær Kunsthall”艺术画廊，感受古老空间里现代艺术装置带来的冲击，体会渔业历史与当代创作的对话。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 5 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`徒步登上村庄后方一座不高的山坡（遵循明显的小径），从高处俯瞰整个亨宁斯韦尔的全景，看桥梁如何像丝线一样将散落的岛屿串成珍珠项链。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 6 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`漫步到东部传统的码头区，这里鱼架林立，如果季节合适，可以看到晾晒的鳕鱼，感受最原汁原味的渔业气息。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 7 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`在村里找一家靠海的咖啡馆，比如“Kafé Brygge”，点一杯热可可或咖啡，配上一块蛋糕，坐在窗边看着潮水慢慢上涨，船只轻轻摇晃。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 8 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`如果还有精力，等到天色渐暗（夏季可能是深夜），再次走到足球场或开阔的码头，等待北极光在夜空中起舞，或欣赏午夜太阳将海面染成金红的奇幻景象。`}</p>
                </div>
              </div>
            </div>
          </Section>
          ...
          <Section title="5. 拍照机位">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">1. {`足球场航拍视角`}</h4>
                  <p className="text-sm text-gray-700">{`如果你带有无人机（务必遵守挪威严格的无人机法规，远离人群和私人区域），从足球场正上方垂直俯拍，能捕捉到绿茵场像一块翡翠镶嵌在黑色礁石和深蓝海洋中的绝妙构图。`}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">2. {`码头与鱼架剪影`}</h4>
                  <p className="text-sm text-gray-700">{`日落前后，在村庄东侧的传统码头，以巨大的、线条交错的木质鱼架作为前景剪影，拍摄背后被晚霞染成粉紫色天空下的彩色木屋群和海港。`}</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">3. {`全景山坡机位`}</h4>
                  <p className="text-sm text-gray-700">{`从村庄后方小山坡的观景点，使用广角镜头，将蜿蜒的堤道、星罗棋布的木屋、背景的巍峨雪山和辽阔海面全部纳入画面，最佳光线在日出后或日落前一小时。`}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">4. {`小巷光影捕捉`}</h4>
                  <p className="text-sm text-gray-700">{`在一个晴朗的午后，走进两条木屋之间狭窄的小巷，等待阳光以极低的角度斜射进来，在斑驳的木板墙和石板路上投下长长的、富有几何感的光影，捕捉那份静谧的孤独感。`}</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">5. {`极光下的足球场`}</h4>
                  <p className="text-sm text-gray-700">{`冬季晴朗无云的夜晚，将相机架在足球场一角，以球门和远处的木屋为地景，长时间曝光拍摄绿色（或粉色）的极光在球场上空蜿蜒舞动的超现实画面。`}</p>
                </div>
              </div>
            ...
            <div className="mt-6 p-4 bg-purple-50 border-l-4 border-purple-400">
              ...
              <ul className="text-sm text-purple-700 space-y-1">
                <li>• {`罗弗敦的光线变化极快且戏剧化，时刻准备好相机。冬季拍摄极光需三脚架、大光圈镜头和高感能力好的相机。切记，在挪威操作无人机有严格限制（重量、禁飞区、隐私），飞行前务必查清当地法规（可通过“挪威民用航空局”App确认）。`}</li>
              </ul>
            </div>
          </Section>
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-blue-800">{`选择一栋正对码头的传统rorbuer（渔民小屋）改造的民宿，晚上听着海浪声入睡，清晨一拉开窗帘就能看到渔船出港和雪山倒影。`}</p>
                </div>
                <div className="bg-green-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-green-900 mb-2">{`艺术设计酒店`}</h4>
                  <p className="text-sm text-green-800">{`入住由历史鱼仓改造的精品酒店，内部是极简的北欧设计风格，保留了原始的木质结构和工业感，通常还自带出色的餐厅或酒吧。`}</p>
                </div>
                <div className="bg-yellow-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-yellow-900 mb-2">{`经济自炊公寓`}</h4>
                  <p className="text-sm text-yellow-800">{`在村子外围租一套带小厨房的公寓，方便你去当地超市购买新鲜海产自己烹饪，像当地人一样生活几天，性价比极高。`}</p>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-purple-900 mb-2">{`独特野奢体验`}</h4>
                  <p className="text-sm text-purple-800">{`如果不介意短途车程，可以选择住在罗弗敦主岛E10公路旁、能同时看到山峰和大海的玻璃屋或现代木屋，享受极致的 wilderness 孤独与安宁。`}</p>
                </div>
              </div>
