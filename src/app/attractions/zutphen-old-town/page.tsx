...
export const metadata: Metadata = {
  ...
  description: '从聚特芬火车站拖着行李箱走出来，迎接你的不是什么现代都市的喧嚣，而是一阵带着青草与河水气息的微风。抬眼望去，一道古老的城墙残垣和一座圆筒形的塔楼就静静地立在街对面，仿佛时间在这里打了个盹儿，忘了向前走。这就是你与聚特芬古城的初次照面——没有夸张的欢迎仪式，只有一种沉稳的、带着砖石温度的存在感。 跟着...',
}
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <Breadcrumb
          items={[
            ...
            { label: '聚特芬', href: '/destinations/netherlands' },
