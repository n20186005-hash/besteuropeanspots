      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <Breadcrumb
          items={[
            ...
            { label: '拉古萨（位于西西里岛东南部）', href: '/destinations/italy' },
            { label: '拉古萨伊布拉（叠落山谷的古城）', href: '/attractions/ragusa-ibla' },
          ]}
        />

        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{`拉古萨伊布拉西西里（叠落山谷的古城）・Ragusa Ibla・意大利・拉古萨（位于西西里岛东南部）`}</h1>
