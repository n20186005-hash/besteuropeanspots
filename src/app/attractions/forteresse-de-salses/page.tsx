      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <Breadcrumb
          items={[
            ...
            { label: '萨尔斯莱沙托 (Salses-le-Château)', href: '/destinations/france' },
            { label: '萨尔斯要塞', href: '/attractions/forteresse-de-salses' },
          ]}
        />

        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{`萨尔斯要塞・Forteresse de Salses・法国・萨尔斯莱沙托 (Salses-le-Château)`}</h1>
          ...
          <Section title="2. 基本信息">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <InfoRow label="中文名称" value={`萨尔斯要塞`} />
                <InfoRow label="英文名称" value={`Forteresse de Salses`} />
                <InfoRow label="正式名称" value={`Forteresse de Salses`} />
              ...
              <div className="space-y-4">
                ...
                <InfoRow label="建筑风格" value={`文艺复兴初期的过渡军事建筑风格，兼具中世纪城堡的威严外观与早期棱堡（Bastion）的几何防御理念，是军事建筑史上承前启后的“活化石”。`} />
            ...
            <div className="mt-6 space-y-3">
              ...
              <InfoRow label="地址" value={`Fort de Salses, 66600 Salses-le-Château, France`} />
              <InfoRow label="交通方式" value={`从最近的机场佩皮尼昂-里韦萨尔特机场出发，驾车沿D83/D900公路向北行驶约20分钟即可抵达。若乘坐火车，可从佩皮尼昂火车站搭乘前往纳博讷方向的区域列车（TER），在“Salses”站下车，车程约15分钟，班次每小时1-2班；出站后步行约20分钟或搭乘出租车（车程5分钟）即可到达要塞。自驾是最方便的选择，要塞入口处设有免费停车场。`} />
            </div>
          </Section>
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <div className="text-sm text-blue-800 bg-blue-100 p-3 rounded">
                  <strong>建议：</strong>{`内部通道复杂且光线幽暗，建议穿一双舒适防滑的鞋子，并利用手机照明看清脚下。
...
部分地下空间低矮且回声重，如果有幽闭恐惧症需谨慎深入，但错过这些区域会损失至少一半的体验精髓。`}
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-700 mb-2">{`从停车场出发，先别急着进门，绕到护城河的南侧，从远处凝视这座半埋于地、砖红如血的庞然大物，感受它如何与土地融为一体。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 2 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`通过古老的吊桥和厚重的大门进入主庭院，瞬间被高大围墙围合的肃穆空间所笼罩，抬头看天空被切割成规则的几何形状。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 3 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`顺着指示牌钻入凉爽的地下通道网络，这里是堡垒的“生命线”，探索储水大厅、面包房和酒窖，想象士兵在此长期坚守的日常。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 4 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`沿着宽阔的斜坡道（供马匹和火炮通行）爬上屋顶平台，眼前豁然开朗，四个巨大的棱堡和宽阔的漫步道构成一个完美的防御棋盘。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 5 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`在屋顶找到通向司令官套房和礼拜堂的楼梯，回到堡垒的生活核心区，看看指挥官的相对“奢华”与士兵宿舍的简朴形成的鲜明对比。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 6 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`从高层沿着城墙内部的“巡逻道”慢慢行走，透过一个个狭长的炮眼和射击孔，以守军的视角向外眺望，目标曾是整个平原。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 7 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`不要错过角落里的常设展览室，那里精致的堡垒模型和历史文献，能帮你把刚才所有的感官碎片拼合成完整的历史图景。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 8 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`最后，从西门离开，再次回望，此时的堡垒在夕阳下会泛着金红色的光，与来时初见的感觉已截然不同。`}</p>
                </div>
              </div>
            </div>
          </Section>
          ...
          <Section title="5. 拍照机位">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">1. {`护城河东南角仰角`}</h4>
                  <p className="text-sm text-gray-700">{`下午四点后的侧光，能将堡垒砖石纹理和巨大体量感完美勾勒，使用广角镜头将堡垒与水中倒影一并纳入，构图极具张力。`}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">2. {`地下储水大厅纵深`}</h4>
                  <p className="text-sm text-gray-700">{`需使用三脚架和长曝光，捕捉从入口拱门射入的光束照亮长达数十米的两排巨型砖砌拱廊，营造出神秘幽深的时间隧道感。`}</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">3. {`屋顶棱堡对角线`}</h4>
                  <p className="text-sm text-gray-700">{`站在西北角的棱堡上，向东南角的棱堡方向拍摄，将屋顶漫步道和雄堞作为引导线，展现堡垒严谨的几何防御布局，最佳光线在晴朗的上午。`}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">4. {`主庭院中心仰望`}</h4>
                  <p className="text-sm text-gray-700">{`正午时分阳光直射入院，站在庭院中心仰拍，能拍到四周高大城墙围合的方形天空，对称构图充满力量与秩序感。`}</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">5. {`西门外远景框景`}</h4>
                  <p className="text-sm text-gray-700">{`利用古老门洞作为天然画框，拍摄门外远方的比利牛斯山和葡萄园，形成“战争遗迹”与“和平田园”的强烈对比，适合黄昏时分。`}</p>
                </div>
              </div>
            ...
            <div className="mt-6 p-4 bg-purple-50 border-l-4 border-purple-400">
              ...
              <ul className="text-sm text-purple-700 space-y-1">
                <li>• {`内部光线复杂，建议使用RAW格式拍摄以便后期调整暗部细节，展现砖石丰富的色彩层次。`}</li>
                <li>• {`尊重历史遗迹，切勿使用闪光灯对古老的壁画和砖石结构直接照射，以免造成损害。`}</li>
                <li>• {`无人机飞行在当地有严格限制，堡垒上空属于禁飞区，请勿尝试以免触犯法律并干扰其他游客。`}</li>
              </ul>
            </div>
          </Section>
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-blue-800">{`坐落在堡垒后方山丘上的独栋石屋民宿，推开木窗就能与萨尔斯要塞遥遥相望，夜晚在露台上看堡垒被星空勾勒的剪影，静谧至极。`}</p>
                </div>
                <div className="bg-green-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-green-900 mb-2">{`老磨坊新生`}</h4>
                  <p className="text-sm text-green-800">{`由19世纪古老磨坊改造的精品酒店，位于萨尔斯莱沙托 village 宁静一隅，石头墙壁和原木横梁诉说着往昔，主人自酿的葡萄酒是每晚的惊喜。`}</p>
                </div>
                <div className="bg-yellow-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-yellow-900 mb-2">{`葡萄园守望者`}</h4>
                  <p className="text-sm text-yellow-800">{`距离堡垒车程10分钟的一片家族葡萄园中央，现代感十足的玻璃房设计，让你在浴缸里边泡澡边欣赏无垠的葡萄田和远山堡垒的侧影。`}</p>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-purple-900 mb-2">{`设计家驿站`}</h4>
                  <p className="text-sm text-purple-800">{`佩皮尼昂市中心一间由设计师经营的精品旅馆，风格简约时髦，是探索完沉重历史后完美的“减压舱”，并且位置方便你继续探索鲁西永地区的色彩与美食。`}</p>
                </div>
              </div>
