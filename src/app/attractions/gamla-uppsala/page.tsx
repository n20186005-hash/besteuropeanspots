    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{`旧乌普萨拉・Gamla Uppsala・瑞典・乌普萨拉省`}</h1>
          <p className="text-lg text-gray-600 mb-6">
            {`车子刚在旧乌普萨拉停下，你就知道自己来到了一个不一样的地方。这里没有拥挤的街道，没有喧闹的商铺，只有一片极其开阔的、仿佛被天空用力压着的草地。风是这里永恒的主人，它呼啸着穿过原野，把高高的草压出一层层银绿色的波浪。空气中是清冽的、带着泥土和青草根茎味道的气息，纯粹得让你一下子忘了自己离现代都市只有二十分钟车程。然后，你的视线就被它们抓住了——那三座巨大的土丘，像三个绿色的、沉睡的巨人，以绝对庄严的三角阵型，稳稳地蹲伏在地平线上。它们的线条是如此柔和，又如此有力，在低垂的北欧云层下，散发着一种近乎催眠的静谧力量。
你沿着小路走向最大的那座坟冢，脚下的碎石沙沙作响，这是此刻唯一属于人类的声音。很难想象，在一千多年前的维京时代，这里会是何等喧嚣鼎沸的景象。考古学家说，这里曾是斯堪的纳维亚最富庶的定居点之一，巨大的长屋，繁忙的集市，而这三座坟冢，则是整个宇宙的中心。对于当时的北欧人来说，埋葬在这里的不是普通的逝者，而是半人半神的传奇国王，他们连接着人间与阿斯加德神域。站在冢脚向上望，坡度平缓却不容小觑，你会不自觉地压低声音，仿佛怕惊醒长眠于其中的英灵。这不是恐惧，而是一种面对浩瀚时间和古老信仰时，油然而生的敬畏。
如今，这片圣地以一种奇异的方式融入了现代瑞典人的生活。你会看到当地人牵着狗在冢间小径慢跑，父母带着孩子在坡上翻滚玩耍，年轻的情侣并肩坐在冢顶，看着夕阳把天空染成维京船帆的颜色。历史在这里不是锁在玻璃柜里的标本，而是他们脚下可以触摸、可以奔跑、可以躺下感受的土地。这种日常与神圣的交织，赋予了旧乌普萨拉一种独特的温度——它既是国家史诗的源头，也是社区公园的后院。
当夕阳西下，游客散去，金色的光芒斜射在古老的土丘和旁边那座红白色的小教堂上时，这种感觉最为强烈。基督教教堂紧挨着异教王陵建造，这本身就是一部无声的、充满张力的历史。光与影在草地和坟冢的曲线上流动，风声里仿佛夹杂着古老的吟唱和铁器的碰撞声。那一刻你忽然明白，旧乌普萨拉最打动人的，不是某一个具体的建筑，而是这片土地本身所承载的、关于生命、死亡、权力和信仰的全部重量。它是一片能让你听见时间回声的风景。`}
          </p>
        </div>
          ...
          <Section title="2. 基本信息">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <InfoRow label="中文名称" value={`旧乌普萨拉`} />
                <InfoRow label="英文名称" value={`Gamla Uppsala`} />
                <InfoRow label="正式名称" value={`Gamla Uppsala`} />
              ...
              <div className="space-y-4">
                ...
                <InfoRow label="建筑风格" value={`北欧铁器时代坟冢（ Högar ）与后来在其旁兴建的中世纪基督教教堂形成鲜明而深刻的历史对话。`} />
            ...
            <div className="mt-6 space-y-3">
              ...
              <InfoRow label="地址" value={`Disavägen, 754 40 Uppsala, Sweden`} />
              <InfoRow label="交通方式" value={`从斯德哥尔摩阿兰达机场（ARN）出发最便捷：在机场乘坐前往乌普萨拉中央火车站的地区列车（UL），车程约18分钟，班次频繁。 抵达乌普萨拉中央火车站后，出站前往市中心的公交枢纽，换乘2路或110路公交车（方向为“Gamla Uppsala”），大约15-20分钟即可直达遗址入口附近的公交站。 从斯德哥尔摩市中心也可直接乘坐火车到乌普萨拉，再转公交。 建议使用UL的公共交通App购买联票，方便且划算。`} />
            </div>
          </Section>
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <div className="text-sm text-blue-800 bg-blue-100 p-3 rounded">
                  <strong>建议：</strong>{`坟冢区域完全露天且风大，无论什么季节，都比市区感觉冷几度，一件防风保暖的外套是必需品。
穿着舒适耐脏的徒步鞋，因为草地可能潮湿，上下土丘的斜坡也需要一定的抓地力。
尊重这里作为古代墓地的肃穆氛围，避免大声喧哗或进行不恰当的娱乐活动。`}
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-700 mb-2">{`从遗址南侧那条被橡树荫遮蔽的沙石小径开始你的朝圣，让脚步先于眼睛去感受这片土地的质地。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 2 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`径直走向三座坟冢中最大的一座，沿着后人走出的小道缓缓绕行一周，用手触碰那些被羊群啃食得短茸茸的草皮。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 3 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`站在三座坟冢构成的三角区域的中心点，闭上眼睛，感受四面八方吹来的风，想象自己正站在千年祭祀广场的中央。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 4 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`走进Gamla Uppsala博物馆，花时间看看那些从土壤中挖出的锈蚀头盔、碎裂的陶罐和精致的首饰，把刚才的想象落到实物。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 5 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`参观那座紧邻坟冢的红色旧乌普萨拉教堂，摸摸它冰凉的石壁，抬头看中世纪留下的简单壁画，体会信仰的变迁。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 6 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`从教堂后面找那条通往“奥丁神龛”的林间小径，这是一段安静的徒步，终点是一处被认为是祭祀遗址的泉眼。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 7 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`回到主坟冢区，选一个你喜欢的小丘，躺在向阳的坡面上，什么也不想，只是看云飘过，直到感觉自己也成为风景的一部分。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 8 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`离开前，别忘了去博物馆的咖啡厅喝一杯热巧克力，从现代温暖的玻璃窗内，再次回望窗外那片苍茫的古老风景。`}</p>
                </div>
              </div>
            </div>
          </Section>
          ...
          <Section title="5. 拍照机位">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">1. {`北侧麦田边缘仰拍`}</h4>
                  <p className="text-sm text-gray-700">{`在夏季傍晚，从坟冢北面远处的麦田边缘用广角镜头拍摄，能将三座墨绿色坟冢、红色小教堂以及金色麦浪和天空的晚霞全部纳入画面，构成层次极其丰富的史诗感全景。`}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">2. {`中间坟冢顶部俯拍`}</h4>
                  <p className="text-sm text-gray-700">{`爬上中间那座坟冢的顶端，将相机贴近地面，拍摄蜿蜒的人行小径如同丝带般缠绕引导视线至另外两座坟冢，突出大地艺术的曲线与几何美感。`}</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">3. {`博物馆二楼露台长焦捕捉`}</h4>
                  <p className="text-sm text-gray-700">{`利用博物馆二楼的开放式露台，用长焦镜头压缩空间，拍摄孤独的访者漫步于巨大坟冢脚下的身影，强烈对比能凸显人类的渺小与历史的浩瀚。`}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">4. {`旧教堂门框取景`}</h4>
                  <p className="text-sm text-gray-700">{`站在旧乌普萨拉教堂低矮的石质门洞内，以门框为画框，向外拍摄正对着的巨大坟冢，这个构图巧妙地寓言了基督教与异教历史的对视与交融。`}</p>
                </div>
              </div>
            ...
            <div className="mt-6 p-4 bg-purple-50 border-l-4 border-purple-400">
              ...
              <ul className="text-sm text-purple-700 space-y-1">
                <li>• {`北欧的阳光角度很低，尤其在秋冬，全天都有机会拍到富有戏剧性的侧光和长影，不必拘泥于“黄金小时”。`}</li>
                <li>• {`如果想拍摄星空下的坟冢，请务必结伴前往，并确认是安全的夜间时段，使用坚固的三脚架。`}</li>
                <li>• {`无人机飞行在此区域可能有严格限制，为尊重遗址及隐私，起飞前务必查清当地法规并取得许可。`}</li>
              </ul>
            </div>
          </Section>
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-blue-800">{`住在乌普萨拉城郊一座由传统木屋改造的民宿里，房东会热情地和你分享当地传说，壁炉里燃着桦木，让你在夜晚继续沉浸在北欧的氛围中。`}</p>
                </div>
                <div className="bg-green-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-green-900 mb-2">{`古城中心设计酒店`}</h4>
                  <p className="text-sm text-green-800">{`选择乌普萨拉市中心河畔的精品酒店，由古老建筑改造，拥有北欧极简设计风格，逛完空旷的遗址后回到充满设计感的温暖空间是绝佳反差享受。`}</p>
                </div>
                <div className="bg-yellow-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-yellow-900 mb-2">{`历史庄园度假村`}</h4>
                  <p className="text-sm text-yellow-800">{`体验稍远一些的乡村庄园酒店，它们往往由贵族庄园改造，被森林和田野环绕，提供桑拿和本地食材晚餐，是探索旧乌普萨拉后完美的奢华休憩所。`}</p>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-purple-900 mb-2">{`学生城青年旅舍`}</h4>
                  <p className="text-sm text-purple-800">{`预算有限的背包客可以选择乌普萨拉大学城附近的青年旅舍，这里充满活力，很容易找到同行者一起规划前往旧乌普萨拉的行程，共享旅行故事。`}</p>
                </div>
              </div>
