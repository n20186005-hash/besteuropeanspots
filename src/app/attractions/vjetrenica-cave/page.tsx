...
export const metadata: Metadata = {
  title: '风洞 Vjetrenica Cave｜探秘波斯尼亚和黑塞哥维那地下王国，在永恒冷风中邂逅珍稀盲螈 - 最佳欧洲景点',
  description: '还没见到洞口，你先感觉到它。在波斯尼亚和黑塞哥维那南部那片被太阳烤得发烫的、布满灰色岩石和低矮灌木的山丘之间，一股清晰、稳定、带着泥土腥味的凉风，像一条无形的河，迎面朝你涌来。这就是“风洞”名字的由来。沿着小路走近，那个不起眼的、被藤蔓半掩的石灰岩洞口，仿佛大地的一个呼吸孔。温度瞬间降了至少十度，那种凉爽不是空调的',
}
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{`风洞・Vjetrenica Cave・波斯尼亚和黑塞哥维那・黑塞哥维那-内雷特瓦州（靠近小镇扎瓦拉）`}</h1>
          <p className="text-lg text-gray-600 mb-6">
            {`还没见到洞口，你先感觉到它。在波斯尼亚和黑塞哥维那南部那片被太阳烤得发烫的、布满灰色岩石和低矮灌木的山丘之间，一股清晰、稳定、带着泥土腥味的凉风，像一条无形的河，迎面朝你涌来。这就是“风洞”名字的由来。沿着小路走近，那个不起眼的、被藤蔓半掩的石灰岩洞口，仿佛大地的一个呼吸孔。温度瞬间降了至少十度，那种凉爽不是空调的刺骨，而是带着湿润水汽的、属于地心深处的寒意。外面世界的蝉鸣鸟叫忽然被吸走了，只剩下风声，永恒不绝的、低沉的“呼呼”声，从黑暗深处传来，邀请你，也警告你。
...
而这个洞穴的灵魂，是那些看不见光的居民。在手电筒光束小心翼翼地扫过一处幽静的水潭时，你可能会看到它——一条苍白、细长、像小蜥蜴般的生物，正缓缓游过。这就是波斯尼亚盲螈，一种只生活在此类纯净地下水域的活化石。它们没有眼睛，皮肤近乎透明，能看见内部粉色的器官。它们在这里生活了数百万年，与世隔绝，进化成最适应永恒黑暗的模样。看着它们，你会震撼于生命的坚韧与奇特。这个洞不是冰冷的景观，它是一个完整、脆弱、呼吸着的生命系统。当地向导谈起盲螈时，语气里总有股近乎神圣的保护欲，你会明白，对这里的人而言，风洞不仅是景点，更是他们土地深处跳动的心脏，一个需要世代守护的秘密。`}
        ...
        <div className="space-y-8">
          ...
          <Section title="1. 景点介绍">
              <p className="text-gray-700 leading-relaxed mb-4">{`还没见到洞口，你先感觉到它。在波斯尼亚和黑塞哥维那南部那片被太阳烤得发烫的、布满灰色岩石和低矮灌木的山丘之间，一股清晰、稳定、带着泥土腥味的凉风，像一条无形的河，迎面朝你涌来。这就是“风洞”名字的由来。沿着小路走近，那个不起眼的、被藤蔓半掩的石灰岩洞口，仿佛大地的一个呼吸孔。温度瞬间降了至少十度，那种凉爽不是空调的刺骨，而是带着湿润水汽的、属于地心深处的寒意。外面世界的蝉鸣鸟叫忽然被吸走了，只剩下风声，永恒不绝的、低沉的“呼呼”声，从黑暗深处传来，邀请你，也警告你。`}</p>
          ...
          <Section title="2. 基本信息">
            ...
            <div className="mt-6 space-y-3">
              ...
              <InfoRow label="门票价格" value={`成人票：15波斯尼亚和黑塞哥维那马克（约合7.5欧元）。学生票（需出示有效国际学生证）：10波斯尼亚和黑塞哥维那马克。6至15岁儿童：8波斯尼亚和黑塞哥维那马克。6岁以下儿童免费。门票费用已包含专业向导服务。只接受当地货币（波斯尼亚和黑塞哥维那马克）现金支付，洞口附近无ATM，请在抵达前于主要城市（如莫斯塔尔）兑换好现金。`} />
              <InfoRow label="地址" value={`Vjetrenica, 88370 Zavala, Bosnia and Herzegovina`} />
              <InfoRow label="交通方式" value={`风洞位于偏远的波斯尼亚和黑塞哥维那乡村，自驾是最灵活的方式。从莫斯塔尔（Mostar）出发，沿M17公路向南朝梅特科维奇（Metković）方向行驶约1小时，转入乡村小路，跟着棕色旅游指示牌“Vjetrenica”行驶即可抵达，全程约80公里，路况尚可但后半段山路弯曲。若使用公共交通：从莫斯塔尔巴士站乘坐前往拉夫诺（Ravno）或杜布罗夫尼克（Dubrovnik，克罗地亚）方向的长途巴士，在扎瓦拉（Zavala）路口下车，但班次极为稀疏（每天仅1-2班），且下车后仍需步行约4公里崎岖山路才能到达洞口，强烈不建议。无火车线路。最稳妥方案是在莫斯塔尔或特雷比涅（Trebinje）租车前往，并预留充足的导航和寻找时间。`} />
            </div>
          </Section>
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="bg-purple-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-purple-800">{`在波斯尼亚和黑塞哥维那与克罗地亚边境附近的森林公园里，寻找仅有几间房的原生态木屋，完全融入自然，白天徒步，晚上在壁炉边读书，安排一天专门拜访风洞。`}</p>
                </div>
              </div>
              <div className="text-gray-700 leading-relaxed">
              <p className="text-gray-700 leading-relaxed mb-4">{`风洞周边住宿选择非常有限且基础，追求舒适和便利的旅行者强烈建议以莫斯塔尔或特雷比涅为住宿中心。夏季（7-8月）是波斯尼亚和黑塞哥维那旅游旺季，莫斯塔尔住宿紧张，务必提前数月预订。乡村地区住宿多接受现金支付，需提前确认。`}</p>
              </div>
            </div>
          </Section>
