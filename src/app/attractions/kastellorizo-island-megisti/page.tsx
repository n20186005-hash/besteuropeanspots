...
这座岛最打动人心的，正是这种强烈的“孤岛感”与“家园感”的对比。它远离一切，孤独地漂浮在深蓝色爱琴海上，距离最近的希腊岛屿罗得岛也有两小时船程，而对岸的土耳其海岸线却清晰可见。然而，就在这弹丸之地上，居民们用极致的色彩和顽强的生活力，建造了一个无比温暖、紧密、自足的世界。每一个刷新的门窗，每一盆精心照料的天竺葵，都是对孤独和遗忘的一种温柔抵抗。你不是来参观一个地方，而是来短暂地踏入一种纯粹、浓缩且濒危的地中海海岛生活方式的核心。`}
        ...
        <div className="space-y-8">
          <Section title="1. 景点介绍">
              <p className="text-gray-700 leading-relaxed mb-4">{`当渡轮缓缓驶入那个被称作“Mandraki”的天然港湾时，你会感觉自己像是一头撞进了一盒被打翻的颜料里。眼前的一切都过于明媚，过于安静，以至于不太真实。赭红、鹅黄、湖蓝、薄荷绿……一排排两层高的小房子像乐高积木一样，严丝合缝地挤在U型海湾的怀抱里，倒映在玻璃般平静的碧绿海水中。空气里是纯粹的、带着咸味的海洋气息，混合着远处某家厨房飘出的烤鱼和 oregano 的香味。除了海水轻轻拍打岸边小船的声音，以及偶尔掠过天空的海鸥鸣叫，这里安静得能听见自己的呼吸。港口边零星坐着几位白发老人，他们喝着希腊咖啡，目光悠长地望着海面，仿佛在等待，又仿佛只是让时间从指缝间流走。`}</p>
              <p className="text-gray-700 leading-relaxed mb-4">{`你会发现，这里没有“景点”的喧嚣感，整个小镇本身就是唯一的、活着的展品。蜿蜒的阶梯小巷窄得只容一人通过，两侧的墙壁在正午的阳光下晒得发烫，色彩饱和度惊人。阳台上的九重葛开得如火如荼，几乎要垂到行人的头上。你随时可能闯入一个只有三张桌子的小 taverna，老板兼任厨师和服务员，菜单就写在门后的黑板上。这里的生活节奏不是“慢”，而是一种近乎凝固的、循环往复的从容。时间不是线性前进的，而是随着日出、渔船归航、教堂钟声和傍晚的散步（volta）而一圈圈旋转。`}</p>
              <p className="text-gray-700 leading-relaxed mb-4">{`这座岛最打动人心的，正是这种强烈的“孤岛感”与“家园感”的对比。它远离一切，孤独地漂浮在深蓝色爱琴海上，距离最近的希腊岛屿罗得岛也有两小时船程，而对岸的土耳其海岸线却清晰可见。然而，就在这弹丸之地上，居民们用极致的色彩和顽强的生活力，建造了一个无比温暖、紧密、自足的世界。每一个刷新的门窗，每一盆精心照料的天竺葵，都是对孤独和遗忘的一种温柔抵抗。你不是来参观一个地方，而是来短暂地踏入一种纯粹、浓缩且濒危的地中海海岛生活方式的核心。`}</p>
          </Section>
          ...
          <Section title="3. 历史背景">
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p className="text-gray-700 leading-relaxed mb-4">{`卡斯特罗里佐的故事，是一部关于战略要地、繁荣、毁灭与坚韧重生的微型史诗。它的古希腊名字“Megisti”意为“最大者”，这对如今这个仅有几平方公里的岛屿来说是个略带讽刺的幽默——它曾经是周围小岛群中最大的一个。在古代，它是一个不起眼的停靠点。命运的转折发生在中世纪，圣约翰骑士团（即医院骑士团）在1306年占领了这里，并建造了那座俯瞰港口、令人望而生畏的红色岩石城堡——“Castello Rosso”，这就是其现代名称“Kastellorizo”（意为红色城堡）的由来。骑士团的红十字旗帜曾在此飘扬，标志着它作为基督教世界在东地中海前哨的角色。`}</p>
              <p className="text-gray-700 leading-relaxed mb-4">{`接下来的几个世纪，它在威尼斯人、埃及人和奥斯曼帝国的夹缝中生存。令人惊讶的是，在奥斯曼统治时期（尤其是19世纪），这个小岛迎来了黄金时代。得益于精明的岛民和优越的港口，它发展成为爱琴海东部重要的贸易和造船中心，拥有庞大的商船队，远航至埃及、黎凡特甚至黑海。那时的港口停满了船只，岛上人口曾超过万人，富裕的船主们建造了那些我们今天看到的、色彩斑斓的新古典主义豪宅，比如著名的“蓝色宫殿”。你能在旧照片里看到一种几乎可与大岛屿媲美的繁华与自信。`}</p>
              <p className="text-gray-700 leading-relaxed mb-4">{`然而，20世纪对卡斯特罗里佐是残酷的。一战和二战将它卷入了大国博弈的漩涡。1915年，法国军队占领该岛，一场灾难性的大火意外焚毁了港口区大量建筑。1920年，根据条约它被划归意大利。二战期间，它遭受了猛烈的空袭和轰炸，因为其战略位置。更沉重的打击发生在战后：1948年该岛正式回归希腊，但经济基础已被彻底摧毁，加之希腊本土政治动荡和经济机会的吸引，岛上居民开始了大规模外迁的“血泪之路”。人口从巅峰时期的过万，锐减至七十年代的寥寥数百人，许多房屋门窗紧闭，荒草丛生，岛屿奄奄一息。`}</p>
              <p className="text-gray-700 leading-relaxed mb-4">{`但故事并没有在荒凉中结束。八十年代末，一群意大利纪录片导演来到这里，拍摄了获得奥斯卡奖的影片《地中海》，这部影片让世界看到了这个被遗忘的彩色天堂。随后，希腊政府开始提供补贴，鼓励散居在世界各地（尤其是澳大利亚）的岛民后裔回归修缮祖屋。这是一场缓慢而坚定的“色彩复兴”。每一栋被重新刷上鲜艳油漆的房子，都是一个家庭对故土的回响。今天你看到的明媚景象，并非未经沧桑的天真，而是一次次劫后余生的、充满自觉的打扮。岛民们用色彩对抗时间的侵蚀和地理的孤绝，他们的历史就写在每一面墙壁的色调里，在每一次“欢迎回来”的问候中。`}</p>
            </div>
          </Section>
          ...
          <Section title="6. 住宿小贴士">
            <div className="space-y-6">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">{`卡斯特罗里佐的住宿数量极其有限，且很多是家庭经营，夏季（6-9月）必须提前至少3-4个月预订，通过邮件或电话直接与房东沟通往往比大型预订平台更可靠。岛上夜间极其安全，但小巷没有路灯，建议携带一个小手电。选择住宿时，留意它是否在港口边（方便但可能傍晚较热闹）还是在上部街区（需要爬阶梯但更安静），根据你的体力偏好决定。`}</p>
              </div>
            </div>
          </Section>
          ...
          <Section title="7. 总结感悟">
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-6 rounded-lg">
              <p className="text-gray-700 leading-relaxed mb-4">{`离开卡斯特罗里佐许久后，你记忆中最鲜明的可能不是某个具体的景点，而是一种整体的“感觉”。那种感觉，是色彩在炽烈阳光下的饱满欲滴，是海水在不同时辰变幻的蓝绿色调，是午间全镇陷入沉寂时，连猫都躲在阴影里打盹的慵懒。你会记得某个老人对你点头微笑时眼角的皱纹，记得小餐馆里那条简单烤制却鲜美无比的鱼，记得在城堡山顶，看着这个微小、脆弱却又无比坚韧的彩色社区被无垠的深蓝大海所包围时，心中升起的那份既孤寂又温暖的复杂情绪。`}</p>
              <p className="text-gray-700 leading-relaxed mb-4">{`在这个追求宏大、高效和流量的世界里，卡斯特罗里佐的存在像一个温柔的悖论。它告诉你，微不足道可以如此丰富，偏远孤绝可以如此治愈，缓慢几近停滞可以如此充实。它是一面镜子，照见我们内心对纯粹、对联系、对带有温度的生活的渴望。来这里，不只是为了看一个“地方”，更是为了体验一种“状态”——一种将生活精炼到最基本、最鲜艳、最人性的状态。每一位真正的旅人，都应该来一次这样的孤岛，让这里的色彩洗刷眼睛，让这里的寂静充盈耳朵，然后带着一小片那片蔚蓝与明黄调和出的内心宁静，重回纷扰的世界。它提醒我们，家园不是一个地理概念，而是一种用心建造和守护的彩色信仰。`}</p>
            </div>
          </Section>
