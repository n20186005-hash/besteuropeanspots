...
export const metadata: Metadata = {
  title: '肖普朗老城 Sopron｜走进匈牙利最具风情的忠诚之城 - 最佳欧洲景点',
  description: '景点简介...',
}

export default function SopronPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <Breadcrumb
          items={[
            ...
            { label: '肖普朗老城', href: '/attractions/sopron' },
          ]}
        />

        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">肖普朗老城</h1>
          <p className="text-xl text-gray-600 mb-4">Sopron</p>
