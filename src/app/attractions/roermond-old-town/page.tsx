...
export const metadata: Metadata = {
  ...
  description: '说实话，第一次听说鲁尔蒙德，很多人脑海里蹦出的可能是那个大名鼎鼎的设计师奥特莱斯。但当你真正穿过那条分隔喧嚣购物村与静谧历史的马路，一脚踏进老城的石板路时，整个世界就像被按下了静音键，同时调高了色彩的饱和度。那种感觉，就像无意中闯入了别人的秘密花园。
首先抓住你感官的，是声音的层次。远处购物村的模糊...',
}
