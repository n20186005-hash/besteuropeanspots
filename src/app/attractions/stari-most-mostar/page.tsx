...
export const metadata: Metadata = {
  title: '莫斯塔尔老桥 Stari Most｜凝视波斯尼亚和黑塞哥维那伤痕与重生的翡翠之眼 - 最佳欧洲景点',
        ...
        <div className="space-y-8">
          ...
          <Section title="2. 基本信息">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <InfoRow label="历史地位" value={`一座始建于16世纪的奥斯曼帝国杰作，在1992-95年波斯尼亚和黑塞哥维那战争中被刻意炸毁，并于2004年依原样重建，成为国家和解与世界文化遗产的象征。`} />
            ...
            <div className="mt-6 space-y-3">
              <InfoRow label="开放时间" value={`桥梁及周边区域全天24小时开放。老桥博物馆夏季（4月至10月）开放时间为上午9点至晚上7点，冬季（11月至3月）为上午10点至下午4点。部分节假日（如波斯尼亚和黑塞哥维那独立日、圣诞节）开放时间可能缩短。`} />
          ...
          <Section title="3. 历史背景">
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">{`几个世纪的风雨和战乱，老桥都奇迹般地挺了过来。奥匈帝国的统治改变了城市风貌，但老桥依然是中心。二战时炸弹在它身边落下，它也安然无恙。它看着一代代莫斯塔尔人长大、老去。桥夫从桥上跳入冰冷河水的传统，也从17世纪开始，成为年轻男子勇气与成熟的成年礼。这座桥，已经深深烙印在城市和居民的集体记忆与身份之中。然而，最大的灾难在20世纪末降临。1992年，波斯尼亚和黑塞哥维那战争爆发，莫斯塔尔陷入惨烈的围城。这座美丽的古城，因其混合人口成了民族冲突的焦点。老桥，这个连接的象征，成了眼中钉。`}</p>
