      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <Breadcrumb
          items={[
            ...
            { label: '马尼半岛', href: '/destinations/greece' },
            { label: '瓦西亚', href: '/attractions/vatheia-towers' },
          ]}
        />

        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{`瓦西亚・Vatheia・希腊・马尼半岛`}</h1>
          <p className="text-lg text-gray-600 mb-6">
            {`车子在仿佛没有尽头的灰色山崖上盘旋，当你几乎要怀疑导航是否出了错时，一片令人窒息的景象会猛地撞入眼帘。那不是山，那是建筑，是上百座灰到发黑的石塔，像一片从大地骨血里骤然刺出的、密密麻麻的冷兵器方阵，毫无预警地矗立在荒芜到极致的海角山巅。第一印象不是美，是一种直击心脏的凛冽和肃杀。风在这里是唯一的声音，呼啸着穿过石塔间狭窄的、如同战壕般的巷弄，发出呜呜的悲鸣，夹杂着远处地中海浪涛拍打悬崖的低吼。空气里是干燥的石头、被烈日灼烤的百里香，以及无边无际的、属于时间和遗忘的气味。
停下车，脚踩在滚烫的碎石路上走近它，那种压迫感有增无减。这些塔楼彼此挨得如此之近，近到你觉得住在隔壁塔顶的人几乎可以从射击孔里碰到对方的手。但它们又如此封闭，高达十几米的墙壁上，除了底部厚重的木门和最高处几个黑洞洞的方孔，再无任何与外界沟通的缝隙。你无法想象这里曾充满炊烟、孩子的哭闹和日常的对话。它更像一个为战争而生的巨型机器，每一块石头都在呐喊着“勿近”。阳光在这里被切割成锐利的几何形状，在巷子深处投下冰冷沉重的阴影，明暗交界线锋利得如同刀片。
然而，就在这片荒芜之中，生命力以最顽强的方式探头。几株仙人掌从石缝里爆出肥厚的绿掌，一丛丛野生的粉色天竺葵，在某个废弃塔楼窗台（如果那能算窗台的话）的石罐里，开得没心没肺。你会突然意识到，这并非纯粹的废墟。零星几座塔楼的烟囱飘出淡淡的炊烟，晾晒的衣物在屋顶的竹竿上轻轻摆动。极少数坚守在这里的老人，可能正从某个射击孔后静静打量着你这不速之客。这里的生活从未真正断绝，只是以一种极度内敛、近乎隐修的方式，与这片严酷的土地达成了最后的和解。它的核心魅力，正是这种极致的矛盾：将人类社群聚居的形态，塑造成了最孤独、最防御性的姿态；在最荒凉死寂的风景里，维系着最坚韧的生命火种。`}
          </p>
        </div>
          ...
          <Section title="2. 基本信息">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <InfoRow label="中文名称" value={`瓦西亚`} />
                <InfoRow label="英文名称" value={`Vatheia`} />
                <InfoRow label="正式名称" value={`Vatheia`} />
              ...
              <div className="space-y-4">
                ...
                <InfoRow label="建筑风格" value={`马尼式拜占庭风格与极端本土防御需求的融合，一种源于生存危机的、质朴而震撼的建筑语言。`} />
            ...
            <div className="mt-6 space-y-3">
              ...
              <InfoRow label="地址" value={`Vatheia 230 62, Greece`} />
              <InfoRow label="交通方式" value={`瓦西亚位于伯罗奔尼撒半岛最南端的马尼半岛深处，交通堪称“朝圣之路”。最近的主要国际机场是卡拉马塔机场（KLX），抵达后你必须租车，这是唯一现实的选择。从卡拉马塔驱车南下，沿着蜿蜒的海岸公路行驶约1.5-2小时，风景从富饶的橄榄园逐渐变为嶙峋的岩石地貌，导航目的地设为“Vatheia”。进入马尼腹地后，路标变得稀少，手机信号时有时无，建议提前下载离线地图。道路最后一段是狭窄崎岖的山路，需谨慎驾驶。几乎没有公共交通能直达这里，最近的巴士站也在几公里外的村庄，班次稀少，依赖公交将耗费大量时间且极不可靠。`} />
            </div>
          </Section>
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <div className="text-sm text-blue-800 bg-blue-100 p-3 rounded">
                  <strong>建议：</strong>{`务必穿着抓地力强的徒步鞋或运动鞋，村内道路全是原始的石块、沙土和陡峭的台阶，高跟鞋或凉鞋寸步难行且危险。
自带充足的饮用水和少量能量零食，村落内及周边没有任何商店、咖啡馆或卖水处，夏季脱水风险极高。
保持绝对的安静和尊重，这里仍有极少居民，且许多废弃塔楼产权私有，切勿未经允许强行进入或大声喧哗，窥探私人空间。`}
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-700 mb-2">{`把车停在村口略高的空地上，先不要急着进去，站在崖边迎着地中海的风，远眺这片灰色塔林与湛蓝大海形成的极致对比。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 2 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`沿着主路径下行，正式踏入塔楼之间那些宽度不足一米的幽深小巷，让眼睛适应昏暗的光线，用手指触摸那些被百年风沙打磨得粗糙又光滑的石壁。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 3 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`在迷宫中心努力寻找一座门扉半掩或完全敞开的废弃塔楼（请务必先高声询问，确认无人后再小心进入），站在它的“客厅”里抬头仰望，感受那如同井底之望的封闭与窒息感。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 4 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`手脚并用地攀爬上一段相对稳固的露天石阶或坡道，抵达村落中层的某片平台，从这里回望你来时的路，看塔楼如何层层叠叠、错落有致地镶嵌在山体上。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 5 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`向着最高处的几座塔楼进发，那里视野最为开阔，可以看到村落完整的、蜂巢般的结构，以及远处另一侧更为荒凉的山谷。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 6 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`如果运气好，遇到一位修复了塔楼的房主并得到友善的许可，可以近距离观察现代生活是如何小心翼翼地嵌入这座古代堡垒的（这是极难得的体验）。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 7 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`在日落前半小时，选一个面向西方的开阔处（可以是村口的悬崖，也可以是某座高塔的脚下），静静坐下，看夕阳如何将冰冷的灰色石头染成暖金、橘红，最后归于沉寂的靛蓝。`}</p>
                </div>
              </div>
            </div>
          </Section>
          ...
          <Section title="5. 拍照机位">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">1. {`村口东侧山丘远眺点`}</h4>
                  <p className="text-sm text-gray-700">{`日落前一小时，使用中长焦镜头压缩空间，能拍出塔楼密集如林、背景是深邃地中海的全景史诗感画面。`}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">2. {`迷宫小巷光影走廊`}</h4>
                  <p className="text-sm text-gray-700">{`正午前后，阳光直射入狭窄巷道，在石壁上切割出强烈的明暗分界线，站在阴影中向亮处拍摄行走的剪影或空镜，极具几何抽象美感。`}</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">3. {`从低处仰拍双塔夹缝`}</h4>
                  <p className="text-sm text-gray-700">{`选择两座特别高耸、距离极近的塔楼，躺在它们之间的巷子底部向上仰拍，能获得极具压迫感和引导线的构图，天空变成一线天。`}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">4. {`某个废弃塔楼内部望天`}</h4>
                  <p className="text-sm text-gray-700">{`如果安全进入内部，将镜头对准头顶那片小小的方形天空，拍摄“坐井观天”式的框架构图，传递出封闭空间的孤独感。`}</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">5. {`夕阳金顶时刻`}</h4>
                  <p className="text-sm text-gray-700">{`日落时分，寻找一座独立在稍高处的塔楼，让金色的阳光只照亮它的顶部，而整体处于阴影中，突出其孤傲的轮廓与质感。`}</p>
                </div>
              </div>
            ...
            <div className="mt-6 p-4 bg-purple-50 border-l-4 border-purple-400">
              ...
              <ul className="text-sm text-purple-700 space-y-1">
                <li>• {`广角镜头在这里用处有限，中长焦镜头（70-200mm）更能捕捉塔楼的结构感和压缩出密集的视觉效果。无人机航拍能获得无与伦比的震撼全景，但务必注意强风，并绝对尊重居民隐私，避免在有人居住的塔楼上空低飞或悬停。马尼人性格刚烈，对隐私极度看重，冒犯的拍摄可能引来严厉的斥责。`}</li>
              </ul>
            </div>
          </Section>
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-blue-800">{`住在车程半小时内沿海小镇吉西奥（Gythio）的家庭旅馆，房间干净简单，推开窗就是宁静的渔港，晚上能在海滨小馆吃到价廉物美的鲜鱼。`}</p>
                </div>
                <div className="bg-green-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-green-900 mb-2">{`特色体验`}</h4>
                  <p className="text-sm text-green-800">{`马尼半岛上由传统塔楼或石屋修复而成的精品民宿，例如在卡米纳（Kamina）或阿雷奥波利（Areopoli）附近，你能真正睡在厚实的石墙之内，体验古旧与现代舒适感的奇妙融合。`}</p>
                </div>
                <div className="bg-yellow-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-yellow-900 mb-2">{`高端享受`}</h4>
                  <p className="text-sm text-yellow-800">{`选择莫奈姆瓦夏（Monemvasia）或科斯塔纳瓦里诺（Costa Navarino）区域的五星级度假酒店，在享受奢华服务与爱琴海美景后，再驱车前往瓦西亚进行一日探险，形成强烈的情感与体验对比。`}</p>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-purple-900 mb-2">{`隐居修行`}</h4>
                  <p className="text-sm text-purple-800">{`直接租赁瓦西亚或附近村庄一座经过现代化改造的完整塔楼（需提前数月预订），成为这片石头王国暂时的“领主”，享受绝对寂静的星空与仿佛拥有全世界荒凉感的日升月落。`}</p>
                </div>
              </div>
