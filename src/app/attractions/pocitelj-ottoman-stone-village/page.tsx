...
更重要的是，你能感觉到这个村子是“活”的。虽然很多房屋依旧带着1990年代战争留下的弹孔痕迹，破损的窗户像失明的眼睛，但你也能看到精心修复的屋顶，新漆的木门，以及那些选择回归的年轻艺术家的工作室。孩子们的叫喊声从某条小巷深处传来，紧接着是母亲的呼唤。宣礼塔的喇叭在固定时间响起，声音悠长，在山谷间回荡，与教堂的钟声（来自邻近地区）形成一种奇妙的、属于波斯尼亚和黑塞哥维那的和谐二重奏。波奇泰利不是博物馆，它是一个伤痕累累却顽强呼吸的有机体，每一块石头都在诉说着生存的故事。`}
          </p>
        </div>
        ...
        <div className="space-y-8">
          <Section title="1. 景点介绍">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">{`更重要的是，你能感觉到这个村子是“活”的。虽然很多房屋依旧带着1990年代战争留下的弹孔痕迹，破损的窗户像失明的眼睛，但你也能看到精心修复的屋顶，新漆的木门，以及那些选择回归的年轻艺术家的工作室。孩子们的叫喊声从某条小巷深处传来，紧接着是母亲的呼唤。宣礼塔的喇叭在固定时间响起，声音悠长，在山谷间回荡，与教堂的钟声（来自邻近地区）形成一种奇妙的、属于波斯尼亚和黑塞哥维那的和谐二重奏。波奇泰利不是博物馆，它是一个伤痕累累却顽强呼吸的有机体，每一块石头都在诉说着生存的故事。`}</p>
          </Section>
          ...
          <Section title="2. 基本信息">
            ...
            <div className="mt-6 space-y-3">
              ...
              <InfoRow label="门票价格" value={`进入波奇泰利古村落本身完全免费。若想登上古老的钟楼（Sahat-kula）俯瞰全景，有时会有一位当地看管人收取象征性的捐赠（约1-2欧元或等值波斯尼亚和黑塞哥维那马克），用于维护。这笔微小的费用完全自愿，但非常值得。`} />
          ...
          <Section title="3. 历史背景">
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">{`威尼斯人撤退后，波奇泰利重归奥斯曼怀抱，但元气已伤。更大的变革在1878年来临，奥匈帝国根据柏林条约，正式接管了波斯尼亚和黑塞哥维那。新的统治者带来了新的秩序、新的建筑风格（你可以在村里看到一些奥匈时期加固的军事掩体），但也加速了古老生活方式的瓦解。波奇泰利逐渐失去了战略重要性，慢慢沉睡，变成了一个偏远的、被时光遗忘的角落。这种“被遗忘”在某种程度上保护了它，让它的奥斯曼肌理得以完整保存到二十世纪，成为了巴尔干地区罕见的“时间胶囊”。`}</p>
              <p className="text-gray-700 leading-relaxed mb-4">{`真正的浩劫在二十世纪末降临。1992年至1996年的波斯尼亚和黑塞哥维那战争期间，波奇泰利因为其位于克族和穆族聚居地交界处的敏感位置，遭受了猛烈的炮击。哈吉-阿里清真寺的尖塔被炸毁，无数古老的石屋被炮弹洞穿，内部木结构焚毁，整个村落几乎沦为一片冒着青烟的废墟。战争结束后，它满目疮痍的模样，是整个国家创伤的缩影。但故事没有结束。从上世纪末开始，在国际援助和本地人坚韧意志的推动下，一场缓慢而精细的重生开始了。清真寺和钟楼被小心翼翼地按原样重建，艺术家和手工艺人被鼓励进驻空置的石屋，开设工作室和画廊。今天的波奇泰利，每一处修复的痕迹都与残破的伤疤并置，这种强烈的对比，恰恰构成了它最动人、最深刻的叙事——不是关于永恒的完美，而是关于破碎后的修复，关于记忆的顽强，关于在灰烬中重新点燃的生活之光。`}</p>
            </div>
          </Section>
...
尊重当地居民隐私，拍照时尽量避免直接对准居民和他们的家居内部，尤其是门窗敞开的屋内景象。`}
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-700 mb-2">{`下山时不必原路返回，可以尝试另一条更贴近民居后院的小路，并在山腰某处视野开阔的露天茶馆点一杯波斯尼亚和黑塞哥维那咖啡，看着夕阳将石头染成金色。`}</p>
                </div>
              </div>
            </div>
          </Section>
          ...
          <Section title="6. 住宿小贴士">
            <div className="space-y-6">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">{`波斯尼亚和黑塞哥维那整体治安良好，但无论住在哪里，夜间在偏僻小巷独自行走仍需保持一般的旅行警觉。`}</p>
              </div>
            </div>
          </Section>
