      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <Breadcrumb
          items={[
            ...
            { label: '塔林', href: '/destinations/estonia' },
            { label: '座堂山城堡', href: '/attractions/toompea-castle-tallinn' },
          ]}
        />

        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{`座堂山城堡・Toompea Castle・爱沙尼亚・塔林`}</h1>
          ...
          <Section title="2. 基本信息">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <InfoRow label="中文名称" value={`座堂山城堡`} />
                <InfoRow label="英文名称" value={`Toompea Castle`} />
                <InfoRow label="正式名称" value={`Toompea Castle and the Estonian Parliament`} />
              ...
              <div className="space-y-4">
                ...
                <InfoRow label="建筑风格" value={`一个生动的建筑史标本，融合了13-14世纪的条顿骑士团城堡遗迹、18世纪俄罗斯帝国的巴洛克式宫殿立面，以及20世纪末爱沙尼亚独立后增添的现代议会功能空间。`} />
            ...
            <div className="mt-6 space-y-3">
              ...
              <InfoRow label="地址" value={`Lossi plats 1a, 10137 Tallinn, Estonia`} />
              <InfoRow label="交通方式" value={`从塔林伦纳特·梅里机场（TLL）出发，最方便的是乘坐出租车，车程约15-20分钟即可直达座堂山脚下。若乘坐公共交通，可搭乘2号电车（方向：Suur-Paala）至“Viru”站下车，然后步行约15分钟上山。从塔林中央火车站或客运码头步行至座堂山脚下约需20-25分钟。上山本身是一段体验，你可以选择从老城内部沿着“长腿街”（Pikk Jalg）或“短腿街”（Lühike Jalg）两条古老的坡道蜿蜒而上，后者更有趣，像是穿越时空隧道。体力一般者建议穿舒适的鞋子。`} />
            </div>
          </Section>
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <div className="text-sm text-blue-800 bg-blue-100 p-3 rounded">
                  <strong>建议：</strong>{`进入议会参观务必提前数天至数周在爱沙尼亚议会官网预约，并携带护照原件，着装需得体（避免背心、短裤、拖鞋）。城堡山区域风大，即使在夏季，也建议带一件防风外套。观景台的石阶有时湿滑，请务必穿一双防滑舒适的鞋子。`}
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-700 mb-2">{`先从城堡西侧的Patkuli观景台开始，迎着晨风将红屋顶的老城全景和远处的波罗的海尽收眼底，建立最初的空间认知。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 2 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`转身沿着城墙根走向城堡广场，用手触摸那些暴露在外的、粗糙冰冷的灰色中世纪巨石基座，感受粉红色外衣下的古老骨骼。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 3 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`从正门欣赏那座童话般的粉红色巴洛克立面，然后绕到侧面，寻找“长赫尔曼”塔楼，仰望塔顶飘扬的爱沙尼亚蓝黑白三色国旗。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 4 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`穿过广场，走进内部庭院，留意地面材质和建筑高度的变化，这里曾是骑士团城堡的内核，如今安静得能听到自己的脚步声。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 5 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`如果预约了议会导览，在指定时间跟随工作人员穿过安检，走进议事大厅，安静观察现代座椅与古老石墙、玻璃穹顶与历史油画并存的奇异空间。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 6 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`导览结束后，从另一侧出口走出，顺势拜访紧邻的亚历山大·涅夫斯基主教座堂，让自己沉浸在东正教堂华丽的视觉冲击与浓郁的香火气息中。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 7 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`最后，不要从原路返回，选择从“长腿街”（Pikk Jalg）那条更开阔、两旁布满古老贵族宅邸的坡道慢悠悠地走下去，完成一次从“上城”权力中心到“下城”市民生活的历史下行体验。`}</p>
                </div>
              </div>
            </div>
          </Section>
          ...
          <Section title="5. 拍照机位">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">1. {`Patkuli观景台全景框`}</h4>
                  <p className="text-sm text-gray-700">{`清晨或日落前黄金一小时，使用广角镜头，将古老的防御城墙作为前景框，将下方色彩斑斓的老城屋顶和圣奥拉夫教堂尖塔作为中景，远处海港作为背景，构成层次极其丰富的画面。`}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">2. {`“长腿街”阶梯仰拍`}</h4>
                  <p className="text-sm text-gray-700">{`下午阳光能洒满阶梯时，站在阶梯中段向上拍摄，利用石阶形成的强烈引导线，将视线引向尽头高大的城堡门洞和天空，营造出朝圣般的纵深感。`}</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">3. {`城堡花园仰拍粉墙`}</h4>
                  <p className="text-sm text-gray-700">{`从城堡南侧的小花园（靠近丹麦国王花园）向上仰拍粉红色的议会大楼立面，以春天的绿树或秋天的黄叶作为柔和的框架，能拍出最具童话感和对比度的建筑肖像。`}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">4. {`亚历山大教堂与城堡同框`}</h4>
                  <p className="text-sm text-gray-700">{`站在城堡广场靠近教堂的一侧，用长焦镜头压缩空间，将洋葱头金顶与粉红色城堡的局部并置在一个画面中，展现两种截然不同的建筑美学与历史叙事的碰撞。`}</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">5. {`议会内部穹顶（如允许拍摄）`}</h4>
                  <p className="text-sm text-gray-700">{`如果导览允许在特定区域拍照，抬头拍摄议事厅上方的现代玻璃穹顶，将其与周围古老的石壁和装饰一同纳入镜头，捕捉历史与现代共生的瞬间。`}</p>
                </div>
              </div>
            ...
            <div className="mt-6 p-4 bg-purple-50 border-l-4 border-purple-400">
              ...
              <ul className="text-sm text-purple-700 space-y-1">
                <li>• {`在议会大楼内部，务必严格遵守导览员的指示，哪些区域可以拍照，哪些绝对不能拍（如涉及安全或会议进程）。使用无人机在塔林老城上空飞行有严格限制，需提前申请许可，在城堡山这种敏感区域上方飞行基本不被允许。尊重当地人，拍摄人物前最好先微笑示意。`}</li>
              </ul>
            </div>
          </Section>
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-blue-800">{`入住座堂山“上城”区域内由中世纪贵族宅邸改造的精品酒店，推开木格窗就能看到议会大楼的粉墙或主教座堂的金顶，夜晚当游客散去，你便能独享这座千年山丘的静谧魔力。`}</p>
                </div>
                <div className="bg-green-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-green-900 mb-2">{`历史沉浸`}</h4>
                  <p className="text-sm text-green-800">{`选择老城“下城”城墙边的设计师酒店，房间由古老的盐仓库改造，保留了原始的砖拱和木梁，位置绝佳，步行两分钟就能开始攀登“短腿街”，体验每日“上下城穿越”。`}</p>
                </div>
                <div className="bg-yellow-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-yellow-900 mb-2">{`高端享受`}</h4>
                  <p className="text-sm text-yellow-800">{`塔林港附近临海的五星级酒店，拥有全景落地窗和露台，让你在舒适的房间里就能同时欣赏到座堂山城堡的雄姿和进出港口的轮船，将历史与现代航海的景致一并收藏。`}</p>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-purple-900 mb-2">{`预算之选`}</h4>
                  <p className="text-sm text-purple-800">{`距离老城东门（Viru Gate）步行仅5-10分钟的温馨家庭式公寓或青年旅舍，深入本地社区，在面包店和蔬果店的香气中醒来，以最接地气的方式走近那座标志性的山丘。`}</p>
                </div>
              </div>
