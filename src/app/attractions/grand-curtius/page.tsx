...
这就是库尔提乌斯最核心的魅力——它本身就是最珍贵的展品。你不仅仅是在“参观”博物馆，你是在“步入”一位16世纪军火大亨的私宅，同时又在穿越一条跨越千年的历史长廊。那种质感是叠加的：指尖划过冰凉的石砌窗台，那是豪宅主人曾经凭栏远眺的位置；眼前陈列的公元7世纪墨洛温骑士的镀金马刺，又把你拽入更古老的传说。在这里，历史不是教科书上扁平的文字，而是可触摸的砖石、可凝视的刀刃、可感受的、从古老壁炉仿佛仍能传来的暖意。它讲述的不仅仅是艺术，更是列日这座城市如何用火与铁，锻造出自己的性格与命运。`}
        ...
        <div className="space-y-8">
          ...
          <Section title="1. 景点介绍">
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "当你从列日老城蜿蜒的鹅卵石街道拐进费龙街，第一眼看到“大库尔提乌斯”时，一定会被那堵巨大的、近乎赭红色的砖墙镇住。它不是那种精致脆弱的宫殿，而像一头蹲伏在默兹河畔的巨兽，厚重、沉稳，砖石在午后阳光下泛着蜂蜜与铁锈混合的暖光。最抢眼的是中央那个被岁月染成翠绿色的铜制圆顶，像一顶古老的王冠，静静俯瞰着流淌的河水。空气中飘来淡淡的河水气息，混杂着老建筑石材特有的、微凉的尘土味。你会发现，当地人对这座建筑的感情很特别，他们不会像游客一样仰头惊叹，而是很自然地穿过它的拱门，去里面的咖啡馆喝一杯，或者只是在中庭的长椅上晒会儿太阳——它早已是城市肌理里一块活着的、呼吸着的骨骼。" }} />
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "推开那扇沉重的木门，室内的光线瞬间暗了下来，时光仿佛在这里被调慢了流速。你的耳朵首先捕捉到的是一种深沉的寂静，偶尔被远处某个展厅传来的轻微脚步声或低语打破。但很快，你的眼睛就适应了。阳光透过高高的、铅条镶嵌的玻璃窗，被切割成一道道柔软的光柱，斜斜地打在深色的橡木地板上，光柱里无数尘埃在缓慢舞蹈。空气中飘着一丝若有若无的木头蜡和金属保养油的味道，那是老博物馆特有的、令人安心的气味。这里的空间感非常奇妙，它不像现代博物馆那样开阔明亮，而是由一连串大小不一的房间、隐秘的回廊和突然出现的旋转楼梯组成，像一座迷人的迷宫。每一个转角都可能遇见惊喜：可能是一套光芒夺目的文艺复兴时期金匠作品，也可能是一整面墙的、寒光凛冽的中世纪长剑。" }} />
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "这就是库尔提乌斯最核心的魅力——它本身就是最珍贵的展品。你不仅仅是在“参观”博物馆，你是在“步入”一位16世纪军火大亨的私宅，同时又在穿越一条跨越千年的历史长廊。那种质感是叠加的：指尖划过冰凉的石砌窗台，那是豪宅主人曾经凭栏远眺的位置；眼前陈列的公元7世纪墨洛温骑士的镀金马刺，又把你拽入更古老的传说。在这里，历史不是教科书上扁平的文字，而是可触摸的砖石、可凝视的刀刃、可感受的、从古老壁炉仿佛仍能传来的暖意。它讲述的不仅仅是艺术，更是列日这座城市如何用火与铁，锻造出自己的性格与命运。" }} />
          </Section>
          ...
          <Section title="3. 历史背景">
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "这个故事得从一个叫让·德·库尔提乌斯的人讲起。时间回到16世纪末，列日地区正处于它历史上最风光的时期。靠着默兹河便利的水运和地下丰富的煤炭资源，这里成了欧洲闻名的武器制造中心和冶金重镇，刀剑、火枪、盔甲从这里源源不断地运往各方战场。让·德·库尔提乌斯就是这波浪潮中涌现的顶级军火商兼实业家，富可敌国。大约在1597年到1600年间，他决定为自己建造一座配得上其财富与地位的宅邸。他选在了默兹河畔，紧邻列日 Prince-Bishops（亲王主教）城堡的脚下，这个位置本身就充满了象征意义——既靠近权力中心，又俯瞰着城市的经济命脉河流。" }} />
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "于是，这座宏伟的宅邸拔地而起。库尔提乌斯没有选择当时贵族钟爱的石灰岩，而是大量使用了本地烧制的红砖，这让建筑从一开始就带上了浓烈的地方烙印。但红砖不等于粗糙，建筑师在细节上极尽奢华：华丽的雕刻窗框、优雅的弧形山墙、还有那个在当时堪称技术奇迹的庞大铜制圆顶。最有趣的是它的双重性格：面向城市的一侧，立面是文艺复兴式的优雅与开放，展示了主人的艺术品味和社会地位；而面向河流的一侧，墙体则异常厚重，窗户窄小，更像一个戒备森严的堡垒或仓库。这完美反映了主人的双重身份：既是附庸风雅的大商人，也是需要严密守护其珍贵“商品”——武器的务实主义者。这里不仅是家，很可能也是他庞大的武器展示厅和秘密仓库。" }} />
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "库尔提乌斯家族在此居住了一个多世纪，直到18世纪初家族没落，豪宅被分割、转售，做过办公场所，也一度荒废。它的转机出现在20世纪初。1905年，列日市政府买下了这栋濒临损毁的建筑，并启动了一项雄心勃勃的修复与扩建计划。他们不仅想拯救这座建筑，更想把它变成一座真正的城市博物馆。修复工作小心翼翼地保留了原有结构，并将周边几座不同历史时期的重要建筑——包括中世纪的“兵器库”和一座18世纪的宅邸——通过巧妙的内部通道连接起来，形成了一个庞大的博物馆建筑群。2009年，经过长达数年的精心翻新，“大库尔提乌斯”以全新面貌开放，它不再是几座孤立的老房子，而成了一个内部浑然一体、讲述完整列日故事的文化殿堂。" }} />
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "漫步其中，你能清晰地读到这些层叠的历史。在原本的武器库大厅里，高耸的拱顶下陈列着闪着寒光的十字弩和全身板甲，仿佛能听到铁匠铺的敲打声。而在文艺复兴风格的沙龙里，精美的弗兰德挂毯和细腻的肖像画，又诉说着主人对精致生活的追求。二战时期，珍贵的藏品被紧急转移，建筑本身也遭受了炮火的擦伤，那些后来修补的砖石，是它沉默的伤疤。今天，它收藏了超过50万件藏品，从史前燧石到新艺术玻璃，但所有这些珍宝，都因为承载它们的这个“容器”——库尔提乌斯宅邸本身——而拥有了更厚重、更动人的叙事力量。它是一本用砖石写成的自传，记录了个人野心、城市兴衰与时代变迁。" }} />
            </div>
          </Section>
          ...
          <Section title={`6. 住宿与餐饮推荐`}>
            <div className="space-y-6">
              ...
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "列日老城中心区域夜晚非常安全，且充满活力，咖啡馆和酒吧会营业到很晚，住在市中心能更好地体验当地夜生活。如果想预订河景房或特色民宿，尤其是旺季（春末至初秋），建议至少提前一个月预订。周末列日经常有文化活动或集市，酒店价格会小幅上扬。" }} />
              </div>
            </div>
          </Section>
          ...
          <Section title="7. 总结感悟">
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-6 rounded-lg">
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "离开库尔提乌斯博物馆很久之后，我脑子里反复回味的，不是某一件具体的金杯或宝剑，而是一种混合的感觉：红砖的温暖、金属的冰凉、幽暗长廊里的木香，以及从古老窗框望出去那一角流动的、现代的默兹河。这地方有种奇特的魔力，它没有试图把历史打扮得光滑完美呈给你看，而是坦率地展示着所有的层次与接缝——16世纪的奢华与20世纪的修补痕迹并存，冷兵器时代的杀伐之气与玻璃艺术的灵动之光共处一室。它让你明白，历史从来不是单一的叙事，而是一层层覆盖、碰撞、融合的复杂产物。" }} />
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "在这个追求瞬时刺激的快节奏世界里，库尔提乌斯提供了一种截然相反的旅行价值：深度沉浸与缓慢连接。它要求你慢下来，用脚步去丈量那些高低错落的房间，用眼睛去适应昏暗光线下的精美细节，用心去想象每一件器物背后活生生的人与故事。来这里，你不是一个被动的观光客，而像一位受邀进入时间密室的探索者。每一位热爱深度游的旅人都该来一次列日，走进这座红砖巨宅，因为它教会你的，是如何通过一栋建筑、一座城市的切片，去理解整个欧洲文明的韧性、创造力与那份厚重如砖石般的美。这趟旅程结束后，你带走的将不仅是照片，而是一段被实体化、可触摸的记忆，和一颗被历史真实质感稍稍填满的心。" }} />
            </div>
          </Section>
