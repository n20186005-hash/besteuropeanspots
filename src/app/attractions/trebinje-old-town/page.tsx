...
export const metadata: Metadata = {
  title: '特雷比涅老城 Trebinje Old Town｜沉静于时光之河，探访波斯尼亚和黑塞哥维那最温柔边城的奥斯曼灵魂 - 最佳欧洲景点',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{`特雷比涅老城・Trebinje Old Town・波斯尼亚和黑塞哥维那・特雷比涅`}</h1>
        ...
        <div className="space-y-8">
          ...
          <Section title="2. 基本信息">
            ...
            <div className="mt-6 space-y-3">
              ...
              <InfoRow label="门票价格" value={`进入特雷比涅老城本身完全免费。老城内部分由私人经营的微型博物馆或历史建筑（如一些老宅改造的艺廊）可能收取象征性的门票，价格通常在2-5波斯尼亚和黑塞哥维那马克（约合1-2.5欧元）之间。城内最主要的景点——特雷比什尼察河畔的步行区和奥斯曼古桥均无需门票。`} />
              <InfoRow label="地址" value={`Stari Grad, Trebinje, Bosnia and Herzegovina`} />
              <InfoRow label="交通方式" value={`最近的国际机场是克罗地亚杜布罗夫尼克机场（DBV），距离特雷比涅约40公里。从机场出发，最方便的方式是提前预订接驳车或租车自驾，车程约45分钟至1小时，沿途是壮丽的达尔马提亚海岸线和山景。也可先乘坐机场大巴到杜布罗夫尼克主巴士站，再换乘前往特雷比涅的跨境巴士，班次每日约4-6班，车程约1.5小时，需在边境准备护照。若从波斯尼亚和黑塞哥维那首都萨拉热窝出发，可乘坐长途巴士，车程约5-6小时，沿途风光如画。老城面积不大，所有精华景点均可步行轻松抵达。`} />
            </div>
          </Section>
          ...
          <Section title="3. 历史背景">
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">{`然而，特雷比涅并非一直平静。它地处帝国边缘，是奥斯曼势力与威尼斯共和国、以及后来的奥匈帝国反复争夺的前线。城墙一次次被加固，又一次次在战火中损毁。但有趣的是，每次征服者带来新的文化印记，都没有完全抹去旧的。当奥匈帝国在19世纪末接管波斯尼亚和黑塞哥维那后，他们带来了中欧的规划理念和折衷主义建筑风格。你会看到一些建筑悄然发生了变化：窗户变得更大，引入了彩绘玻璃和装饰性的灰泥，但建筑的基调和石材依旧。这种“层叠”而非“覆盖”，成了特雷比涅建筑美学的核心。`}</p>
              <p className="text-gray-700 leading-relaxed mb-4">{`二十世纪的风暴席卷了整个巴尔干，特雷比涅也未能幸免。两次世界大战的阴影，以及上世纪九十年代那场惨烈的波斯尼亚和黑塞哥维那战争，都在它身上留下了伤痕。一些古老的建筑被炮火损坏，一些家庭被迫流离失所。但特雷比涅人似乎从他们的石头和河流中继承了某种坚韧。战争结束后，人们没有急于用崭新的现代建筑取代一切，而是小心翼翼地、一块石头一块石头地修复他们的老城。这个过程缓慢而艰难，却充满了尊严。他们修复的不仅是房子，更是共同记忆和身份认同的锚点。`}</p>
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-700 mb-2">{`当灯光陆续亮起，河面倒映出点点星光时，再去北岸找一家有现场“sevdah”（波斯尼亚和黑塞哥维那传统民谣）演奏的小酒馆，让忧伤而深情的旋律为这一天画上句号。`}</p>
                </div>
              </div>
            </div>
          </Section>
