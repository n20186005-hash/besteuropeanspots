      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <Breadcrumb
          items={[
            ...
            { label: '帕兰加', href: '/destinations/lithuania' },
            { label: '帕兰加琥珀博物馆', href: '/attractions/palanga-amber-museum' },
          ]}
        />

        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{`帕兰加琥珀博物馆・Palanga Amber Museum・立陶宛・帕兰加`}</h1>
          ...
          <Section title="2. 基本信息">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <InfoRow label="中文名称" value={`帕兰加琥珀博物馆`} />
                <InfoRow label="英文名称" value={`Palanga Amber Museum`} />
                <InfoRow label="正式名称" value={`帕兰加琥珀博物馆（帕兰加琥珀博物馆）`} />
              ...
              <div className="space-y-4">
                ...
                <InfoRow label="建筑风格" value={`19世纪末的新文艺复兴风格，带有浪漫主义时期庄园建筑的典型特征。`} />
            ...
            <div className="mt-6 space-y-3">
              ...
              <InfoRow label="地址" value={`Vytauto g. 17, Palanga 00135, Lithuania`} />
              <InfoRow label="交通方式" value={`从最近的国际机场——克莱佩达国际机场（KUN）出发，最佳方式是乘坐出租车或提前预订接送车辆，车程约35-40分钟，费用约30-40欧元。如果从立陶宛首都维尔纽斯或第三大城市克莱佩达出发，乘火车抵达帕兰加火车站是最地道的选择。从克莱佩达火车站到帕兰加火车站的区域列车班次频繁，车程约30分钟，出站后步行约25分钟或乘坐本地公交（如3路、4路）即可抵达博物馆所在的植物园区域。帕兰加城市小巧，步行或租借自行车是游览的最佳方式。`} />
            </div>
          </Section>
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <div className="text-sm text-blue-800 bg-blue-100 p-3 rounded">
                  <strong>建议：</strong>{`夏季（6-8月）是帕兰加的旅游旺季，博物馆内可能拥挤，尽量选择工作日早晨前往体验更佳。参观博物馆内部时请务必遵守规定，不要用手触碰展柜玻璃，闪光灯摄影在大部分区域是被禁止的。穿着舒适的步行鞋至关重要，因为你至少有一半时间会在广阔的植物园内行走。`}
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-700 mb-2">{`从植物园主入口进入，沿着两侧栽满奇花异木的中央林荫大道缓缓向宫殿方向漫步，让自己被绿色的宁静和海风的气息浸透。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 2 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`不要急着进入博物馆，先绕到宫殿的背面露台，那里是俯瞰大片草坪、观赏宫殿建筑优雅侧影并与巨大古松合影的绝佳位置。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 3 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`推开宫殿正门，首先在门厅稍作停留，仰望华丽的彩绘玻璃天花板，然后从左翼的历史展厅开始你的琥珀时光之旅。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 4 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`在历史展厅里仔细寻找那些古代琥珀护身符和贸易地图，想象维京商队如何带着这些“北方黄金”穿越欧洲。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 5 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`步入核心的珍宝厅，屏住呼吸靠近那些装有昆虫、植物甚至蜥蜴的珍稀琥珀标本，感受与史前生命面对面凝视的震撼时刻。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 6 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`上到二楼，在“琥珀在艺术中”的展厅里，欣赏从新石器时代简单钻孔珠子到洛可可时期极致繁复首饰的演变，领略人类技艺如何与自然造化对话。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 7 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`别忘了参观博物馆内按原样保留的伯爵“包含琥珀的房间”，看看贵族如何将这种材料奢华地运用在家具和内饰中，完成从自然标本到生活美学的概念跨越。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 8 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`从博物馆出来后，前往位于宫殿一角的纪念品商店，亲手触摸几块温润的琥珀原石，或许能带走一件独一无二的小艺术品作为回忆。`}</p>
                </div>
              </div>
            </div>
          </Section>
          ...
          <Section title="5. 拍照机位">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">1. {`宫殿正面仰拍`}</h4>
                  <p className="text-sm text-gray-700">{`清晨或傍晚，站在宫殿前广场的喷泉附近，用广角镜头将宫殿的黄色立面、白色柱廊与上空舞动的古松树枝一同纳入画面，构图充满张力与生机。`}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">2. {`松林琥珀光斑`}</h4>
                  <p className="text-sm text-gray-700">{`选择一个阳光强烈的正午，走进宫殿旁的松林，将相机对准铺满松针的地面或苔藓斑驳的树干，寻找阳光透过琥珀饰品（可手持一小块）投射下的金色光斑，进行创意微距拍摄。`}</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">3. {`观景台全景`}</h4>
                  <p className="text-sm text-gray-700">{`从博物馆二层的某个朝西的窗户或露台（如果开放）向外拍摄，将前景的宫殿建筑细节作为画框，聚焦于远处无垠的波罗的海海面，形成历史与永恒自然的时空对话。`}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">4. {`植物园小径纵深`}</h4>
                  <p className="text-sm text-gray-700">{`在植物园的一条笔直沙石小径上，利用两侧高大乔木形成的天然“隧道”，拍摄人物向宫殿走去的背影，营造出深邃、宁静且有引导感的叙事画面。`}</p>
                </div>
              </div>
            ...
            <div className="mt-6 p-4 bg-purple-50 border-l-4 border-purple-400">
              ...
              <ul className="text-sm text-purple-700 space-y-1">
                <li>• {`拍摄琥珀展品时，请绝对关闭闪光灯，强烈的闪光会损害古老的有机宝石。可利用展厅内的专业照明，调高ISO并寻找支撑点进行拍摄。在植物园进行人像摄影时，柔和的晨光或夕阳光线最能衬托出森林秘境的氛围，海风常常吹动发丝和衣角，不妨利用这个自然元素增添动感。`}</li>
              </ul>
            </div>
          </Section>
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-blue-800">{`步行至博物馆仅需15分钟的经典海滨度假酒店，房间配有阳台，夜晚枕着波罗的海舒缓的涛声入眠，早晨在咸湿的海风中苏醒。`}</p>
                </div>
                <div className="bg-green-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-green-900 mb-2">{`市中心便利之选`}</h4>
                  <p className="text-sm text-green-800">{`位于帕兰加主街附近的精品旅馆，由传统木屋改造而成，装饰充满立陶宛民族风情，晚上可以轻松探索小镇热闹的餐厅和咖啡馆。`}</p>
                </div>
                <div className="bg-yellow-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-yellow-900 mb-2">{`森林沉浸之选`}</h4>
                  <p className="text-sm text-yellow-800">{`隐藏在植物园边缘区域的静谧度假小木屋，被高大的松树和鸟鸣环绕，推开门就是自然，是真正与博物馆环境融为一体的居住体验。`}</p>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-purple-900 mb-2">{`设计师风格之选`}</h4>
                  <p className="text-sm text-purple-800">{`由克莱佩达建筑师设计的现代公寓，拥有开阔的落地窗和极简内饰，从城市视角提供另一种欣赏这座度假小镇的当代方式。`}</p>
                </div>
              </div>
