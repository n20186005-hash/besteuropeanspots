    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{`科利国家公园・Koli National Park・芬兰・北卡累利阿区（主要入口城镇为约恩苏或利埃克萨）`}</h1>
          <p className="text-lg text-gray-600 mb-6">
            {`车子在无尽的松林与闪亮的湖泊之间穿行，当你开始觉得这片绿与蓝的韵律将永远持续下去时，道路一个转弯，它毫无征兆地出现了。那不是山，在见惯阿尔卑斯雄姿的欧洲大陆，科利的海拔几乎称得上谦卑。但那是一片突然从地平线上撕裂开来的、裸露着白色脊梁的悬崖，像一头巨大的、沉睡的古老生物，静静地卧在皮耶利宁湖深蓝色的绒布上。第一眼，你就会被那种沉默的威严攫住。空气瞬间变得清冽，混合着松针的冷香和湖水蒸腾起来的、略带腥甜的湿润气息。
爬到半山腰，耳朵里只剩下风穿过云杉林顶的呜咽，以及自己踩在厚实苔藓和碎石上的沙沙声。偶尔，一声清亮的鸟鸣划破寂静，反而让周遭显得更加深邃。这里没有恢弘的乐章，只有大自然最原初的白噪音。站在乌科山顶的观景台，视野豁然开朗。眼前是芬兰的缩影：皮耶利宁湖像一块被轻轻敲裂的深蓝色玻璃，碎片洒向远方，化为无数岛屿和湾流；森林是各种绿色的拼贴画，墨绿、翠绿、黄绿，一直延伸到世界尽头的地平线，那里天地交融，模糊成一片柔光。
你会发现，这里不只是游客的打卡地。身边常能看到穿着实用冲锋衣的芬兰家庭，父母轻声向孩子解释着某种苔藓的名字；或是装备专业的徒步者，向你点头致意后便沉默地没入林间小径。科利之于芬兰人，就像黄山之于中国人，是一种刻在骨子里的风景基因，是远行时怀念的故乡模样，是寻求内心宁静时必须回归的“圣地”。它的核心魅力不在于震撼，而在于一种深沉的抚慰。它让你相信，世界仍有如此开阔、宁静、一尘不染的角落，时间在这里是以森林的年轮和冰川的擦痕来计算的。`}
          </p>
        </div>
          ...
          <Section title="2. 基本信息">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <InfoRow label="中文名称" value={`科利国家公园`} />
                <InfoRow label="英文名称" value={`Koli National Park`} />
                <InfoRow label="正式名称" value={`Koli National Park`} />
              ...
              <div className="space-y-4">
                ...
                <InfoRow label="建筑风格" value={`纯粹的斯堪的纳维亚古老地质风格，覆盖着苍翠的混交林和苔原植被。`} />
            ...
            <div className="mt-6 space-y-3">
              ...
              <InfoRow label="地址" value={`Koli National Park, 83960 Koli, Finland`} />
              <InfoRow label="交通方式" value={`从最近的主要交通枢纽是约恩苏市（Joensuu）。飞机：可飞抵约恩苏机场（JOE），从赫尔辛基转机约1小时。从约恩苏机场租车自驾前往科利（约80公里，1小时车程）是最便捷的方式。火车：从赫尔辛基乘坐VR国铁至约恩苏火车站，车程约4-5小时，班次频繁。从约恩苏火车站，可搭乘季节性的巴士前往科利（班次较少，夏季可能每天2-3班，耗时约1.5小时），但更建议提前预订出租车或租车。自驾是探索该区域最推荐的方式，沿途森林湖泊风光无限。`} />
            </div>
          </Section>
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 p-6 rounded-lg">
                ...
                <div className="text-sm text-blue-800 bg-blue-100 p-3 rounded">
                  <strong>建议：</strong>{`夏季（6-8月）蚊蚋非常多，务必携带强效防虫喷雾并穿着长袖衣物。无论什么季节，都必须穿防滑耐走的徒步鞋，山顶岩石潮湿时非常滑。天气变化极快，即使在夏季，山顶也可能大风寒冷，一件防风防水外套是背包里的必需品。`}
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-700 mb-2">{`把车停在乌科山脚下的主停车场，先别急着上山，沿着标识清晰的“自然小径”走进山麓的混交林，用手触摸冰凉光滑的羊背石，辨认云杉、松树和白桦树的不同气味。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 2 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`拜访科利自然中心 Ukko，通过互动展览了解这片土地从冰川时代到民族象征的史诗，别忘了在观景咖啡厅的落地窗前喝杯咖啡，让眼前的全景图先印在脑海里。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 3 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`沿着平缓的步道向最高峰 Ukko-Koli 进发，在最后一个拐角处刻意停留一会儿，调整呼吸，然后让那幅闻名世界的全景画面完整地撞入眼帘。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 4 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`在山顶的观景台不必久留，转而探索向东延伸的山脊小径，前往 Pieni-Koli 和 Akka-Koli 山峰，从不同角度发现皮耶利宁湖千变万化的姿态。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 5 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`下山后绕到湖畔的 Herajärvi 小码头，坐在木长椅上，听湖水轻拍岸石的声音，如果是在夏季，勇敢的你可以尝试一下清澈见底但冰冷刺骨的湖水。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 6 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`选择一条较长的环线步道，比如通往 Kapeeniemeni 半岛的路线，深入感受国家公园内部的原始森林，那里苔藓厚如地毯，寂静只被自己的脚步声打破。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 7 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`在日落前一小时重返 Ukko-Koli 山顶，看着夕阳将白色的岩壁染成金黄，再变成粉红，湖对岸的利埃克萨镇灯光逐渐星星点点亮起。`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <h4 className="font-semibold text-gray-900 mb-2">第 8 步</h4>
                  <p className="text-sm text-gray-700 mb-2">{`第二天若有时间，驱车前往公园内另一个区域，如 Rykiniemi 或 Mäkrä，体验更荒野的徒步或是在导游带领下了解传统的“火烧森林”生态管理。`}</p>
                </div>
              </div>
            </div>
          </Section>
          ...
          <Section title="5. 拍照机位">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">1. {`乌科山顶经典全景位`}</h4>
                  <p className="text-sm text-gray-700">{`日落前黄金一小时或日出后蓝调时刻，使用广角镜头，将前景的岩石、中景的森林与湖泊、远景的天空全部纳入，构图时注意湖岸线的引导线。`}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">2. {`森林小径光影捕捉点`}</h4>
                  <p className="text-sm text-gray-700">{`阳光明媚的上午或下午，选择一条有阳光斜射的林间小路，蹲低机位，让光线穿透树冠，形成一道道光束，以湿润的苔藓和蕨类植物为前景。`}</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">3. {`皮耶利宁湖滨的“镜子”机位`}</h4>
                  <p className="text-sm text-gray-700">{`在无风的清晨，前往 Herajärvi 码头附近，将相机贴近平静如镜的湖面，拍摄科利山脊的完美倒影，对称构图极具禅意。`}</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">4. {`Kapeeniemi 观景台的框架构图`}</h4>
                  <p className="text-sm text-gray-700">{`在这个伸向湖中的半岛观景台，利用木质围栏或自然的树枝形成一个画框，将远处的山峰和湖泊框在其中，增加照片的层次感和故事性。`}</p>
                </div>
              </div>
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-gray-900 mb-2">5. {`冬季极光与山景融合点`}</h4>
                  <p className="text-sm text-gray-700">{`在极光活跃的晴朗冬夜，于 Ukko-Koli 山顶或附近开阔地，将山峰深色的剪影作为前景，捕捉绿色紫色极光在湖面上空舞动的奇幻景象。`}</p>
                </div>
              </div>
            ...
            <div className="mt-6 p-4 bg-purple-50 border-l-4 border-purple-400">
              ...
              <ul className="text-sm text-purple-700 space-y-1">
                <li>• {`尊重“每个人的权利”，拍照时不要为了构图而偏离步道践踏脆弱的地衣和苔原植被。拍摄森林和微距生态时，一支三脚架和微距镜头能帮你发现另一个世界。冬季拍摄极光需做好严密的防寒准备，相机电池在低温下消耗极快，需贴身保暖备用。`}</li>
              </ul>
            </div>
          </Section>
            ...
            <div className="space-y-6">
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-blue-800">{`国家公园周边散布着许多自助式小木屋（如“mökki”），需要自带睡袋和食物，但价格亲民，让你在松涛声中入眠，是沉浸式体验芬兰田园生活的绝佳选择。`}</p>
                </div>
                <div className="bg-green-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-green-900 mb-2">{`特色湖畔设计酒店`}</h4>
                  <p className="text-sm text-green-800">{`如“Break Sokos Hotel Koli”，坐拥无敌湖景，北欧设计风格与自然环境完美融合，桑拿房正对着落地窗外的森林，蒸完桑拿跳进清凉的湖水是终极芬兰体验。`}</p>
                </div>
                <div className="bg-yellow-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-yellow-900 mb-2">{`高端荒野酒店`}</h4>
                  <p className="text-sm text-yellow-800">{`位于山顶附近的“Koli Nature Resort Ukko”，部分房间拥有直面全景的阳台，提供从美食到向导服务的全套高端体验，醒来便置身于风景画中央。`}</p>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h4 className="font-semibold text-purple-900 mb-2">{`温馨家庭民宿`}</h4>
                  <p className="text-sm text-purple-800">{`公园附近农场或村庄里的民宿，主人通常会热情介绍当地的秘密徒步点，并端上自家制作的浆果派和新鲜牛奶，充满人情味。`}</p>
                </div>
              </div>
