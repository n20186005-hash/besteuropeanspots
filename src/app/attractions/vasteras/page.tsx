...
export const metadata: Metadata = {
  title: '北欧小众旅行｜韦斯特罗斯实用攻略，新手也能轻松逛 - 最佳欧洲景点',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">韦斯特罗斯</h1>
          <p className="text-xl text-gray-600 mb-4">Vasteras</p>
          <div className="flex flex-wrap gap-2 mb-6">
            <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">瑞典</span>
            <span className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm">韦斯特罗斯</span>
          </div>
        </div>
