...
export const metadata: Metadata = {
  title: '格拉达查茨 Gradačac 龙之塔｜攀登波黑传奇的白色巨塔，聆听奥斯曼边境的抵抗史诗 - 最佳欧洲景点',
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{`格拉达查茨・Gradačac・波斯尼亚和黑塞哥维那（波黑）・格拉达查茨`}</h1>
...
这座要塞对于当地人而言，远不止是一个旅游景点。它是每日生活的背景板。你在街角咖啡馆喝咖啡时，一抬眼就能看到它；孩子们在广场上踢球，它沉默地守护在一旁。它已经和这里的天空、土地长在了一起。最打动人的，是那种强烈的反差感：塔楼本身是那么威严、冷峻，一道坚不可摧的军事剪影；可当你走近，发现城堡的庭院绿草如茵，有老人在长椅上晒太阳，有情侣在城墙边依偎着看落日，战争的棱角被日常的温情慢慢磨圆了。它既讲述着波黑历史上最激烈的一段抗争，也静静地容纳着当下最平和的市井生活。
爬到塔楼脚下，用手触摸那些巨大的石块，冰凉而粗糙的质感瞬间将你与几个世纪前的工匠连接起来。你可以想象当年守卫的士兵，就是靠着这同样的石墙，眺望着北方平原可能出现的烟尘。此刻，你取代了他们，眼前是无比安宁的景象：小镇的房屋像彩色的积木，教堂的尖顶和清真寺的宣礼塔和谐共存，更远处是无边无际的田野和森林。这座塔最核心的魅力，就在于它提供了一个上帝视角，让你同时看到了历史的重量与当下的轻盈，看到了冲突的伤痕与愈合的宁静，所有关于波黑复杂过去的疑问与感慨，仿佛都能在这俯瞰中，找到一丝无言的理解。`}
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <Section title="1. 景点介绍">
              ...
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "这座要塞对于当地人而言，远不止是一个旅游景点。它是每日生活的背景板。你在街角咖啡馆喝咖啡时，一抬眼就能看到它；孩子们在广场上踢球，它沉默地守护在一旁。它已经和这里的天空、土地长在了一起。最打动人的，是那种强烈的反差感：塔楼本身是那么威严、冷峻，一道坚不可摧的军事剪影；可当你走近，发现城堡的庭院绿草如茵，有老人在长椅上晒太阳，有情侣在城墙边依偎着看落日，战争的棱角被日常的温情慢慢磨圆了。它既讲述着波黑历史上最激烈的一段抗争，也静静地容纳着当下最平和的市井生活。" }} />
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "爬到塔楼脚下，用手触摸那些巨大的石块，冰凉而粗糙的质感瞬间将你与几个世纪前的工匠连接起来。你可以想象当年守卫的士兵，就是靠着这同样的石墙，眺望着北方平原可能出现的烟尘。此刻，你取代了他们，眼前是无比安宁的景象：小镇的房屋像彩色的积木，教堂的尖顶和清真寺的宣礼塔和谐共存，更远处是无边无际的田野和森林。这座塔最核心的魅力，就在于它提供了一个上帝视角，让你同时看到了历史的重量与当下的轻盈，看到了冲突的伤痕与愈合的宁静，所有关于波黑复杂过去的疑问与感慨，仿佛都能在这俯瞰中，找到一丝无言的理解。" }} />
          </Section>
          ...
          <Section title="2. 基本信息">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <InfoRow label="历史地位" value={`19世纪波黑反抗奥斯曼帝国中央集权统治的象征，被誉为“波黑龙”胡塞因·卡佩坦·格拉达什切维奇的大本营。`} />
                <InfoRow label="建筑特色" value={`一座宏伟的白色方形塔楼（龙之塔）雄踞于山丘之巅，俯瞰着整片平原地带，是波黑北部最醒目和保存最完好的奥斯曼时期防御工事之一。`} />
                <InfoRow label="建筑风格" value={`奥斯曼帝国军事建筑风格，兼具欧洲堡垒的坚实与东方亭阁的优雅元素。`} />
                <InfoRow label="文化价值" value={`它不仅是军事要塞，更是一个关于地方自治、勇气与悲剧的文化记忆锚点，深刻影响着波黑的国家认同和民间传说。`} />
              </div>
            </div>
            ...
            <div className="mt-6 space-y-3">
              ...
              <InfoRow label="门票价格" value={`进入城堡庭院和外围区域免费。若要登上标志性的“龙之塔”（胡塞因·卡佩坦要塞主塔）并参观内部的历史展览，需要购买门票。成人票约5波黑马克（约合2.5欧元），学生和儿童享有优惠票价。有时会提供包含塔楼和附近城市博物馆的联票。现场购票即可，通常只接受当地货币现金。`} />
              <InfoRow label="地址" value={`Husein-kapetan Gradaščević bb, 76250 Gradačac, Bosnia and Herzegovina`} />
              <InfoRow label="交通方式" value={`从波黑首都萨拉热窝出发是最常见的选择。在萨拉热窝长途汽车站乘坐前往图兹拉或直接到格拉达查茨的巴士，车程大约2.5至3小时，班次一天数趟，但建议提前一天确认时刻表。若从图兹拉市出发，车程约45分钟，班次更为频繁。自驾是最灵活的方式，从萨拉热窝沿M17公路向北，转入M18.1公路即可抵达，沿途是波黑宁静的乡村风光。小镇内步行即可到达城堡，它矗立在山丘上，从主广场任何一个方向都能轻易望见。`} />
            </div>
          </Section>

          <Section title="3. 历史背景">
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "故事要从19世纪初说起，那时的波黑还是奥斯曼帝国的一个边疆省份。格拉达查茨这个地方的贵族，格拉达什切维奇家族，世代掌管着这片区域，就像是帝国在北方的一根定海神针。而我们的主角，胡塞因·卡佩坦·格拉达什切维奇，在1820年代成为了家族的领袖。他可不是普通的地方官，人们形容他高大威猛，富有魅力和野心，更重要的是，他对自己的家乡和人民有着极强的责任感。当他看到帝国中央推行那些不顾地方传统、加重赋税的改革时，他心中的不满就像火种一样被点燃了。他觉得，帝国已经忘记了如何尊重这些为它守卫边疆的勇士。" }} />
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "于是，他开始做两件事：一是凝聚人心，二是修建堡垒。这座我们今天看到的白色巨塔，正是在他的主持下，在原有防御工事的基础上加固和扩建而成的，成为了他力量和决心的有形象征。它被称为“龙之塔”，而胡塞因本人也被拥戴为“波黑之龙”。1831年，火药桶终于爆炸了。胡塞因领导了一场声势浩大的起义，反抗苏丹的统治。他的军队一度势如破竹，几乎控制了整个波黑，并威胁到帝国核心。这座白色的要塞，成为了起义的指挥中心和精神灯塔。你可以想象，战马在城堡下来回奔驰，信使匆匆进出高大的塔门，胡塞因或许就站在塔顶，谋划着如何为他的土地争取更大的自治权。" }} />
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "然而，帝国的力量是强大的。在经历了一系列激烈的战斗后，起义最终被镇压。胡塞因·卡佩坦被迫流亡，最终在异乡去世，至死未能再回到他心爱的白色塔楼之下。他的要塞，也随之沉寂下来，从反抗的司令部，变回了帝国边疆一个普通的驻防点。但“龙”的传说却没有死去，它成为了波黑人民心中关于自由和抵抗的一个原始符号。此后的一个多世纪，要塞经历了奥匈帝国的统治、南斯拉夫时期，默默见证着历史的潮起潮落。" }} />
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "真正的劫难发生在1990年代的波黑战争期间。格拉达查茨所在的位置是激烈的战场，这座见证了19世纪战火的要塞，不幸再次被卷入20世纪末的悲剧。它在炮火中严重受损，尤其是那座标志性的白塔，伤痕累累，几乎成为废墟。战争结束后，人们看着这座残破的、象征着本地骄傲的遗迹，心情无比复杂。它就像这个国家本身的隐喻，饱经创伤。但正因如此，它的重建被赋予了非凡的意义。经过漫长而精心的修复，白塔重新站了起来，洁白如初。这次修复，不仅仅是用水泥填补弹孔，更是一次集体的疗愈行为，是当地人向历史致敬、并决心走向未来的宣言。今天的它，既承载着胡塞因时代的英雄悲歌，也铭刻着近代战争的伤痕记忆，是一座活着的历史纪念碑。" }} />
            </div>
          </Section>
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-sm text-gray-700 mb-2">{`沿着狭窄而盘旋的石阶一口气登上“龙之塔”的顶层观景台，让波黑北部无垠的平原全景像画卷一样在你眼前猛然展开`}</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
          ...
          <Section title="7. 总结感悟">
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-6 rounded-lg">
              ...
              <p className="text-gray-700 leading-relaxed mb-4" dangerouslySetInnerHTML={{ __html: "在当今这个快节奏的、常常追求浮华体验的世界里，格拉达查茨提供了一种截然不同的旅行价值。它不急于取悦你，不提供轻松的答案。它只是静静地在那里，邀请你去攀登，去触摸那些冰凉的石头，去眺望那片承载了太多故事的土地。在这个过程中，你会自然而然地开始思考历史的分量、民族的记忆，以及平凡人在大时代中的抉择与命运。对于每一位真正热爱深度游的旅人来说，这里不仅仅是一个景点，它是一个沉思的角落，一个让你与波黑这个复杂而美丽的国家进行一场真诚、安静对话的起点。把它的名字列入清单，不是为了收集又一个地标，而是为了去亲身感受，一种伤痕如何最终化为力量，一段传奇如何在后人的珍视中，获得永恒的白。" }} />
            </div>
          </Section>
