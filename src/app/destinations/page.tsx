...
const GLOBAL_REGIONS = {
  ...
  欧洲: ['法国', '比利时', '卢森堡', '德国', '意大利', '西班牙', '奥地利', '瑞士', '捷克', '斯洛伐克', '匈牙利', '斯洛文尼亚', '克罗地亚', '黑山', '希腊', '瑞典', '挪威', '丹麦', '芬兰', '罗马尼亚', '塞尔维亚', '北马其顿', '立陶宛', '爱沙尼亚', '葡萄牙', '波黑', '英国', '荷兰', '阿尔巴尼亚', '科索沃', '拉脱维亚', '马耳他', '保加利亚', '波兰', '俄罗斯', '白俄罗斯', '乌克兰', '摩尔多瓦', '冰岛', '爱尔兰', '安道尔', '摩纳哥', '列支敦士登', '圣马力诺', '梵蒂冈'],
  ...
  大洋洲: ['澳大利亚', '新西兰', '巴布亚新几内亚', '所罗门群岛', '瓦努阿图', '微克罗尼西亚', '马绍尔群岛', '帕劳', '瑙鲁', '基里巴斯', '图瓦卢', '萨摩亚', '斐济', '汤加', '库克群岛', '纽埃']
};
